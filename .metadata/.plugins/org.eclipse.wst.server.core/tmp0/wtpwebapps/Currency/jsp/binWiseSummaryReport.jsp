...
<link rel="shortcut icon" href="./resoudiscrepancyDemandrces/logo/favicon.ico" type="image/x-icon">
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-71" data-genuitec-path="/Currency/src/main/webapp/jsp/binWiseSummaryReport.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-71" data-genuitec-path="/Currency/src/main/webapp/jsp/binWiseSummaryReport.jsp">
		<!-- Navigation -->
										...
										<tbody>
											<c:forEach var="row" items="${binWiseSummaryList}">
												...
												<tr>
													...
													<td>${row.binType}</td>
													<td><fmt:formatDate pattern="dd-MMM-yy" value="${row.updateTime.time}" /></td>
												</tr>
											</c:forEach>
										</tbody>
									</table></div></div>
