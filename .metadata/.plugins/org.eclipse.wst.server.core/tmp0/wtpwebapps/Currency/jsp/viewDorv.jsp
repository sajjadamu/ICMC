...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-224" data-genuitec-path="/Currency/src/main/webapp/jsp/viewDorv.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-224" data-genuitec-path="/Currency/src/main/webapp/jsp/viewDorv.jsp">
        <!-- Navigation -->
                        	...
                        	<ul>
                        		<li>
                        			<sec:authorize access="hasRole('ADD_DIVERSION_PAYMENT')">
                        				<a href="././Dorv"><i class="fa fa-table fa-fw"></i> Add Diversion Payment</a>
                        			</sec:authorize>
                        		</li>
							</ul>Diversion Data
                        </div>
                                      ...
                                      <c:forEach var="row" items="${records}">
										<tr>
											...
											<td>${row.totalValue}</td>
											 ...
											 <td><sec:authorize access="hasRole('UPDATE_DIVERSION_PAYMENT')">
											 ...
											 </td></c:if><c:if test="${row.otherStatus=='ACCEPTED' or row.otherStatus=='RELEASED'}">
