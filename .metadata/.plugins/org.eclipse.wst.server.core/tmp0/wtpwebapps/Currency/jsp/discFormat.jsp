...
<style type="text/css">
  .dispencery_wrap { font-size: 12px;}
  .dispencery_wrap table tr th { border:1px solid #000; padding:3px;}
  .dispencery_wrap   table, td { border: 1px solid black; text-align:center; padding:5px;}    
  td, th { display: table-cell; vertical-align: inherit;}  
  .dispencery_wrap tr td:nth-child(17) {  text-align: left;}
  .dispencery_wrap tr td:nth-child(18) { text-align: left;}
  .dispencery_wrap tr:nth-child(1) { background:#bdf7f7;}
  .dispencery_wrap tr:nth-child(2) { background:#bdf7f7;}
  .dispencery_wrap tr:nth-child(3) { background:#bdf7f7;}
  .dispencery_wrap tr:nth-child(4) { background:#bdf7f7;}
  .dispencery_wrap tr:nth-child(48) { background:#f7f6bd;}
  .dispencery_wrap tr:nth-child(49) { background:#f7f6bd;}
  .dispencery_wrap tr:nth-child(50) { background:#f7f6bd;}
  .dispencery_wrap tr:nth-child(51) { background:#f7f6bd;}
  .dispencery_wrap tr:nth-child(52) { background:#f7f6bd;}
  .dispencery_wrap {font-size: 12px; overflow-x: scroll; width: 100%; float: left;}
  .fakeCls{ font-size:14px; text-align:center; font-weight:bold;}
  .dscTopCls{ font-size:14px; text-align:left; font-weight:bold;}
  tr.ttlDisc {background: #eee;}
  .ttlDisc td {font-size: 14px;  padding: 5px; font-weight: bold;}
  .ttlDiscBtm td {text-align: left; border: none; padding: 6px;} 	
  tr.ttlDiscBtm td:nth-child(2), tr.ttlDiscBtm td:nth-child(3) {background:#f1f1c9; border:#d3d488 1px solid}
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-89" data-genuitec-path="/Currency/src/main/webapp/jsp/discFormat.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-89" data-genuitec-path="/Currency/src/main/webapp/jsp/discFormat.jsp">
		<!-- Navigation -->
					...
					<div class="panel panel-default">
						...
						<form id="showAll">
							...
							<div id="table_wrapper">
					          <table cellspacing="0" >
						         <tr>
						             <th class="dscTopCls" colspan="24">DISCREPANCY SHEET FOR DTD ${currentDate}</th>
						         </tr>
				                  ...
				                  <tr>
						             ...
						             <th class="fakeCls" colspan="10">Note Serial Number & Discrepancy</th>
						             <th class="fakeCls" colspan="2">Identification&nbsp;on Packet / Bundle</th> 
					              ...
					              <tr>
					                ...
					                <th>Parameter based on which classified&nbsp;as Counterfeit</th>  
								  ...
								  <c:set var="count" value="${count + 1}" scope="page" />
					               <tr>
					                  ...
					                  <td><fmt:formatDate pattern="yyyy-MM-dd" value="${innerRow.dateOnShrinkWrap}" /></td>
					               </tr>
					              </c:forEach>
					             </c:forEach>
					             ...
					             <tr class="ttlDisc">
					               ...
					               <tr class="ttlDiscBtm">
					                <td colspan="14"></td> 
					                <td colspan="4">Amount to Parked by Link Branch in ${linkBranchSolId}SAIRREM</td>
			                     ...
			                     <tr class="ttlDiscBtm">
					                <td colspan="14"></td>  
					                <td colspan="4">Amount to Parked by Link Branch in ${linkBranchSolId}SADSCASH</td>
					                <td>${sadscashTotal}</td>  
					                <td colspan="5"></td>  
					              </tr>
					              ...
					              <tr class="ttlDiscBtm">
					              	<td colspan="14"></td>   
					                <td colspan="4">Amount to Parked by Link Branch in ${linkBranchSolId}SLIRREM</td>
					                <td>${excessTotal}</td>  
					                <td colspan="5"></td>             
					              </tr>
