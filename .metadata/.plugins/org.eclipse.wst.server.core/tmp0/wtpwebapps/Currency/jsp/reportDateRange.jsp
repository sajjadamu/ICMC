...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false"
	data-genuitec-file-id="wc1-183"
	data-genuitec-path="/Currency/src/main/webapp/jsp/reportDateRange.jsp">
		...
		<form:form id="userPage" name="userPage" action="${dateRangeURL}"
			...
			<div class="region-con-sec">
				<ul class="region-drop">
					<li><label>Select From Date</label> <span> <form:input
								type="text" path="fromDate" id="fromDate" name="fromDate"
								cssClass="form-control" />
					</span></li>

					<li><label>Select To Date</label> <span> <form:input
