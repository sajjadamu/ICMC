...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-200" data-genuitec-path="/Currency/src/main/webapp/jsp/viewAssignVaultCustodian.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-200" data-genuitec-path="/Currency/src/main/webapp/jsp/viewAssignVaultCustodian.jsp">
        <!-- Navigation -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
							...
							</ul>View Vault Custodian Details
                        </div>
                        <!-- /.panel-heading -->
