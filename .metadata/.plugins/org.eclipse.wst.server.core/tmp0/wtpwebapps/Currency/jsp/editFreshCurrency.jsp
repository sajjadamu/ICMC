...
<title>ICICI : Modify Fresh Currency</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-115" data-genuitec-path="/Currency/src/main/webapp/jsp/editFreshCurrency.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-115" data-genuitec-path="/Currency/src/main/webapp/jsp/editFreshCurrency.jsp">
		<!-- Navigation -->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Modify Fresh Currency Details</div>
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-6">
									<!--<form role="form">-->
									<form:form id="userPage" action="updateFreshCurrency" method="post" name="userPage"
										modelAttribute="user" >
