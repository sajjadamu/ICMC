...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false"
	data-genuitec-file-id="wc1-79"
	data-genuitec-path="/Currency/src/main/webapp/jsp/chestSlip.jsp">
						...
						<jsp:include page="reportDateRange.jsp" /> --%>
							...
							<div class="chestslipreport" id="printableArea">
								<div id="table_wrapper">
									<table width="100%">
										<tr>
											<Td><b>Net Position for ICCI Bank Ltd,
													________________________________ ICMC's for Currency
													Transfer of Chests</b></Td>
										</tr>
									</table>
									<table cellspacing="0">
										<tbody>
											<tr>
												<td colspan="7" rowspan="2" align="left">The Dy General
													Manager,<br> Reserve Bank of India,<br> Issue
													Department, 6 Pr Street, New Delhi -110001
												</td>
												<td colspan="12" align="center">ICICI BANK LTD</td>
											</tr>

											<tr>
												<td colspan="12" align="left">ICICI BANK LTD.
													${icmcName}, ${icmcAddress}</td>
											</tr>

											<tr>
												<td></td>
												<td colspan="5" align="left">CURRENCY TRANSFER OF
													CHESTS</td>
												<td></td>
												<td></td>
												<td></td>
											...
											<tr>
												...
												<td>Total Value</td>
												<td rowspan="11" valign="top" align="left">ICICI BANK
													LTD. ${icmcName}, ${icmcAddress}</td>
												<td>Notes</td>
												<td>One Rs Note</td>
												<td colspan="2">Coins Value</td>
												<td>Total Value</td>
