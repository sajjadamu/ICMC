...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false"
	data-genuitec-file-id="wc1-237"
	data-genuitec-path="/Currency/src/main/webapp/jsp/viewLockedUser.jsp">
										...
										<tbody>
											<c:forEach var="row" items="${records}">
												<tr id="xy${row.id}">
													...
													<td>${row.name}</td>
													<td><fmt:formatDate pattern="dd-MMM-yy HH:mm:ss.SSS"
															value="${row.lastAuthFail.time}" /></td>
													<td><input type="button" value="Unlock"
														onclick="doAjaxPostUnlockUser()"></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
