...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false"
	data-genuitec-file-id="wc1-238"
	data-genuitec-path="/Currency/src/main/webapp/jsp/viewMachineCompany.jsp">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-heading">
							<ul>
								<li><sec:authorize access="hasRole('ADD_MACHINE_COMPANY')">
										<a href="././addMachineCompany"><i
											class="fa fa-table fa-fw"></i> Add Machine Company</a>
									</sec:authorize></li>
							</ul>
							List of Machine Company
						</div>
										...
										<tbody>
											<c:forEach var="row" items="${records}">
												<tr>
													...
													<td>${row.address}</td>
													<td><sec:authorize
															access="hasRole('UPDATE_MACHINE_COMPANY')">
