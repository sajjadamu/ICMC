...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false"
	data-genuitec-file-id="wc1-56"
	data-genuitec-path="/Currency/src/main/webapp/jsp/addPrinter.jsp">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<ul>
								<li><a href="././viewPrinter"><i
										class="fa fa-table fa-fw"></i> View Printer's List</a></li>
							</ul>
							Add New Printer
						</div>
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-6">
									<!--<form role="form">-->
									<form:form id="userPage" name="userPage" action="savePrinter"
										method="post" modelAttribute="icmcPrinter"
										enctype="multipart/form-data" autocomplete="off">

										<div align="center" style="color: red">
											<b>${duplicatePrinter}</b>
										</div>

										<div class="form-group">
											<label>Printer Name</label>
											<form:input path="printerName" id="printerName"
												name="printerName" maxlength="45" cssClass="form-control" />
										</div>
										...
										<div class="form-group">
											<label>Port</label>
											<form:input path="port" id="port" name="port" maxlength="4"
