...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-1" data-genuitec-path="/Currency/src/main/webapp/jsp/AcceptDORVIndent.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-1" data-genuitec-path="/Currency/src/main/webapp/jsp/AcceptDORVIndent.jsp">
        <!-- Navigation -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="tableValue">
                                    ...
                                    <tbody>
	                                    <c:forEach var="row" items="${records}">
		                                    <tr id="xy${row.id}">
			                                    <input type="hidden" value="${row.diversionOrvId}" id="diversionOrvId${row.id}">
