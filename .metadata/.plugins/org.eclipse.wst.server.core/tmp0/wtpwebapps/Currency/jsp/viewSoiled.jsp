...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-259" data-genuitec-path="/Currency/src/main/webapp/jsp/viewSoiled.jsp">

    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-259" data-genuitec-path="/Currency/src/main/webapp/jsp/viewSoiled.jsp">
                          ...
                          <ul>
                          	<li>
                          		<sec:authorize access="hasRole('ADD_SOILED_REMITTANCE')">
                          			<a href="././Soiled"><i class="fa fa-table fa-fw"></i> Add Soiled </a>
                          		</sec:authorize>
							</li>
                          </ul>Soiled Remittance Data
                        </div>
                        <!-- /.panel-heading -->
   ...
   <c:forEach var="row" items="${records}">
				<tr>
					...
					<td><fmt:formatDate pattern="dd-MMM-yy"  value="${row.approvedRemittanceDate}"/></td>
					<td>${row.notes}</td>
					<td>${row.types}</td>
				...
				<td>
				<input type="button" value="Cancel" onclick="doAjaxPostCancel(${row.id})"/></td>
												</c:if>
