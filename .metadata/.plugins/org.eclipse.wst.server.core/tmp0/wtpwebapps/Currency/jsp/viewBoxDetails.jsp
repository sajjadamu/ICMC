...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-210" data-genuitec-path="/Currency/src/main/webapp/jsp/viewBoxDetails.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-210" data-genuitec-path="/Currency/src/main/webapp/jsp/viewBoxDetails.jsp">
        <!-- Navigation -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
	                        <ul>
	                        	<li>
	                        		<a href="././createBox"><i class="fa fa-table fa-fw"></i> Add New Box</a>
	                        	</li>
							</ul>View Box Details
                        </div>
