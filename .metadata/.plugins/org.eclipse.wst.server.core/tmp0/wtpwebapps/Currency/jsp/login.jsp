...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-161"
	data-genuitec-path="/Currency/src/main/webapp/jsp/login.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false"
		data-genuitec-file-id="wc1-161"
		data-genuitec-path="/Currency/src/main/webapp/jsp/login.jsp">
