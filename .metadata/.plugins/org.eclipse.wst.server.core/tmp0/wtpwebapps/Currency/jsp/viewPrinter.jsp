...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-250" data-genuitec-path="/Currency/src/main/webapp/jsp/viewPrinter.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-250" data-genuitec-path="/Currency/src/main/webapp/jsp/viewPrinter.jsp">
        <!-- Navigation -->
                        	...
                        	<ul>
                        		<li>
                        			<%-- <sec:authorize access="hasRole('ADD_PRINTER')"> --%>
                        				<a href="././addPrinter"><i class="fa fa-table fa-fw"></i> Add Printer</a>
                        			<%-- </sec:authorize> --%>
                        		</li>
                        	</ul>Printer's List
                        </div>
												...
												<td>${row.status}</td>
					 							<td>
					 								<%-- <sec:authorize access="hasRole('UPDATE_PRINTER')"> --%>
					 									<a href="editPrinter?id=${row.id}">Edit</a>
					 								<%-- </sec:authorize> --%>
					 							</td>
											</tr>
										</c:forEach>
