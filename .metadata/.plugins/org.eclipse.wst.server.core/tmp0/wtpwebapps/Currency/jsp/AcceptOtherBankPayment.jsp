...
<link rel="shortcut icon" href="./resources/logo/favicon.ico" type="image/x-icon">
    <title>ICICI : Accept Other Bank Payment</title>
    ...
    function doAjaxPostUpdateStatus(str) {  
     ...
     $.ajax({  
  	  ...
  	  contentType : 'application/json; charset=utf-8',
  	    url: "././acceptOtherBankPayment",
  	  data: JSON.stringify(otherPaymentAccept),
  	    success: function(response){  
  	     // $('#info').html(response);
  	     console.log("other bank response "+response);
  	     $("#xy"+str).hide();
  	    }, 
  	    error: function(e){  
  	      alert(' Error: ' + e);  
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-3" data-genuitec-path="/Currency/src/main/webapp/jsp/AcceptOtherBankPayment.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-3" data-genuitec-path="/Currency/src/main/webapp/jsp/AcceptOtherBankPayment.jsp">
        <!-- Navigation -->
            ...
            <div class="row">
				...
				<th>Action</th>
                                    ...
                                    <tbody>
                                      ...
                                      <tr id="xy${row.id}">
                                      <input type="hidden" value="${row.otherBankId}" id="otherBankId${row.id}">
					...
					<td><sec:authorize access="hasRole('ACCEPT_INDENT')">
							<input type="button" value="Accept" onclick="doAjaxPostUpdateStatus(${row.id})">
						</sec:authorize>
					</td>
				</tr>
			</c:forEach>
