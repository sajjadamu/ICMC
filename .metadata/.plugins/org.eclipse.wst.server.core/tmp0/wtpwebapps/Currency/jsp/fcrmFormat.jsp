...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-144" data-genuitec-path="/Currency/src/main/webapp/jsp/fcrmFormat.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-144" data-genuitec-path="/Currency/src/main/webapp/jsp/fcrmFormat.jsp">
		<!-- Navigation -->
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="region-con">
							<form:form id="userPage" name="userPage" action="fcrmFormat" method="post" modelAttribute="reportDate" autocomplete="off">
