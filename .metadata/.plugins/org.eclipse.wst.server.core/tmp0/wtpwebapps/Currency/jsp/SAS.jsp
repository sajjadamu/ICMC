...
<style type="text/css">
table.fresh-main tr td {padding: 5px;width: 44px !important;text-align: center;}
table.fresh-main td.fresh span, table.fresh-main td.freshi span {font-weight: bold;	color: #F5821F;}
.denote {color: #F5821F;}
tr.hover-none, tr.hover-none:hover {background: #053C6D !important;}
.currency-value tr td {	border: 1px solid #ddd;	padding: 5px;}
table.currency-value {float: left;}
.currency-value tr td table tr td {padding: 5px;width: 85px;}

/* Custom CSS  */
.currency-value tr td td {border-left: none; border-bottom: none; border-top: none;}
.currency-value tr>td {padding-bottom: 0 !Important; padding-top: 0 !important;}
...
input[type="button"]:hover, .button-design a:hover {background: white; color: #F5821F !important}
.valbox {width: 35px; text-align: center;}
.cancelButton {float: right;}
.borNon{border: none !important; position: relative;}
.borNon:before {content: ""; position: absolute; top: -6px; width: 49.5%; height: 10px; right: 0; background: #fff;}
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-37" data-genuitec-path="/Currency/src/main/webapp/jsp/SAS.jsp">
<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-37" data-genuitec-path="/Currency/src/main/webapp/jsp/SAS.jsp">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<ul>
							<li><a href="././UploadSAS"><i class="fa fa-table fa-fw"></i>
									Upload SAS</a></li>
						</ul>
						Cash Indent Summary
					</div>
									...
									<tbody align="left">
										...
										<c:forEach var="row" items="${records}">
											...
											<tr>
												...
												${row.totalValue}
													<%-- ${((row.totalValueOfCoinsRs1)*(1*2500))
												...
												<td><c:if test="${enableDisableVar==1 }">
													...
													<input type="button" id="removeBranchRecord${row.id}" value="Remove"
													 onclick="doAjaxPostRemoveBranch(${row.id})">
				...
				<div>
					...
					<table class="currency-value" border="0" cellpadding="0"
						...
						<tr>
							<td>
								<sec:authorize access="hasAnyRole('ADD_SAS')">
...
//display logic. 
 ...
 %>
											<a href="cancelSAS?sasIdList=<%= sasList%>" 
												onclick="return confirm('Are you sure you want to cancel this SAS File?');">Cancel ORV</a>
										</div>
									</sec:authorize>
								</div>
							</td>
