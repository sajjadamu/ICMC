...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-198" data-genuitec-path="/Currency/src/main/webapp/jsp/viewAccountDetails.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-198" data-genuitec-path="/Currency/src/main/webapp/jsp/viewAccountDetails.jsp">
        <!-- Navigation -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                        	<ul>
                        		<li>
                        			<sec:authorize access="hasAnyRole('VIEW_ACCOUNT_DETAILS')">
                        				<!-- <a href="././addAccountDetails"><i class="fa fa-table fa-fw"></i> Add Account Details</a> -->
                        			</sec:authorize>
                        		</li>
                        	</ul>Account Details List
                        </div>
                        <!-- /.panel-heading -->
