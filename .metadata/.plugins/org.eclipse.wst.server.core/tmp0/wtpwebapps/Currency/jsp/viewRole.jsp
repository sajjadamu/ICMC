...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-256" data-genuitec-path="/Currency/src/main/webapp/jsp/viewRole.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-256" data-genuitec-path="/Currency/src/main/webapp/jsp/viewRole.jsp">
        <!-- Navigation -->
                        	...
                        	<ul>
                        		<li>
                        			<sec:authorize access="hasRole('ADD_ROLE')">
                        				<a href="././addRole"><i class="fa fa-table fa-fw"></i> Add New Role</a>
                        			</sec:authorize>
                        		</li>
                        	</ul>View Roles List
                        </div>
