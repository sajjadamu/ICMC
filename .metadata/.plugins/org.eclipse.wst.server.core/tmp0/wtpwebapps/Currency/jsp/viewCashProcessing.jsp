...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-217" data-genuitec-path="/Currency/src/main/webapp/jsp/viewCashProcessing.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-217" data-genuitec-path="/Currency/src/main/webapp/jsp/viewCashProcessing.jsp">
        <!-- Navigation -->
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          ...
                          <li><a href="././cashProcessing"><i
								class="fa fa-table fa-fw"></i> Add Discrepancy Processing Data</a></li>
								
								</ul>
                        Discrepancy Processing Details
                        </div>
                        <!-- /.panel-heading -->
				...
				<tr>
					<td>${row.machineNo}</td>
					<td>${row.date}</td>
					<td>${row.descripancy}</td>
					<td>${row.solId}</td>
					<td>${row.branch}</td>
					<td>${row.denomination}</td>
					<td>${row.account_teller_cam}</td>
					<td>${row.account_teller_cam_value}</td>
