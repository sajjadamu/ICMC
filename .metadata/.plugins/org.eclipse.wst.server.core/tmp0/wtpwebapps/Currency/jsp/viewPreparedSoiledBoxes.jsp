...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-249" data-genuitec-path="/Currency/src/main/webapp/jsp/viewPreparedSoiledBoxes.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-249" data-genuitec-path="/Currency/src/main/webapp/jsp/viewPreparedSoiledBoxes.jsp">
        <!-- Navigation -->
                        	...
                        	<ul>
                        		<li>
                        			<%-- <sec:authorize access="hasRole('ADD_DIVERSION_PAYMENT')"> --%>
                        				<a href="././soiledPreparation"><i class="fa fa-table fa-fw"></i> Preparation for Soiled Remittance</a>
                        			<%-- </sec:authorize> --%>
                        		</li>
							</ul>View Prepared Soiled Boxes
                        </div>
                       <div>
