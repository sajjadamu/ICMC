...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-248" data-genuitec-path="/Currency/src/main/webapp/jsp/viewOtherBankPayment.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-248" data-genuitec-path="/Currency/src/main/webapp/jsp/viewOtherBankPayment.jsp">
        <!-- Navigation -->
                    ...
                    <div class="panel panel-default">
                          ...
                          <ul>
                          	<li>
                          		<sec:authorize access="hasRole('ADD_OTHER_BANK_PAYMENT')">
                          			<a href="././otherBankPayment"><i class="fa fa-table fa-fw"></i> Add Other Bank </a>
                          		</sec:authorize>
							</li>
                          </ul>Other Bank Payment Data
                        </div>
                        <!-- /.panel-heading -->
						...
						<td><a href="editViewOtherBankPayment?id=${row.id}">Edit</a></td>
						 ...
						 <%-- <c:if test="${row.status=='ACCEPTED' or row.status=='RELEASED'}">
											 ...
											 <c:if test="${row.status=='REQUESTED'}">   <td>
												<sec:authorize access="hasRole('UPDATE_OTHER_BANK_PAYMENT')">
