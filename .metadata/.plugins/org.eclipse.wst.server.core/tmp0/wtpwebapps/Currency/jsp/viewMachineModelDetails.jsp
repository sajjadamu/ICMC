...
<link rel="shortcut icon" href="./resources/logo/favicon.ico" type="image/x-icon">
    <title>ICICI : Machine Model List</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-242" data-genuitec-path="/Currency/src/main/webapp/jsp/viewMachineModelDetails.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-242" data-genuitec-path="/Currency/src/main/webapp/jsp/viewMachineModelDetails.jsp">
        <!-- Navigation -->
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          <ul>
                          <li><a href="././addMachineModelDetails"><i
								class="fa fa-table fa-fw"></i> Add Machine Model Details</a></li>
								</ul>
                       List of Machine Model
                        </div>
                        <!-- /.panel-heading -->
			 ...
			 <th>Standard Productivity</th>
				...
				<tr>
					<td>${row.machineModelType}</td>
						<td>${row.standardProductivity}</td>
					<td><a href="editMachineModel?id=${row.id}">Edit</a></td>
