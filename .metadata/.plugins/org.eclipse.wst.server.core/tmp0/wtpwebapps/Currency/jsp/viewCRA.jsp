...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-215" data-genuitec-path="/Currency/src/main/webapp/jsp/viewCRA.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-215" data-genuitec-path="/Currency/src/main/webapp/jsp/viewCRA.jsp">
        <!-- Navigation -->
