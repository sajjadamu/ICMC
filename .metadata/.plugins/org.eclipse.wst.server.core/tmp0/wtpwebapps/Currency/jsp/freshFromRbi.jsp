...
var html='<tr><th>Denomination</th><th>Bundle</th><th>Total</th><th>BOX</th></tr>' ;
	for (i = 0; i < val; i++) {
html += '<tr id="main'+i+'">'+
		'<td><input type="text" id="Denomination'+i+'" maxlength="4" minlength="1"  class="form-control input-margin"  value="" ></td>'+
...
function replicateValueForCoins(i){
	...
	i++;
	var data = '<tr id="main'+countrow+'">'+
	'<td><input type="text" id="Denomination'+countrow+'" maxlength="4" minlength="1"  class="form-control input-margin"  value="'+denomData+'" ></td>'+
