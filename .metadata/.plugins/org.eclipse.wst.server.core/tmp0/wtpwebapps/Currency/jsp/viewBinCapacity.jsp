...
<link rel="shortcut icon" href="./resources/logo/favicon.ico" type="image/x-icon">
    <title>ICICI : View Bin Capacity</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-205" data-genuitec-path="/Currency/src/main/webapp/jsp/viewBinCapacity.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-205" data-genuitec-path="/Currency/src/main/webapp/jsp/viewBinCapacity.jsp">
        <!-- Navigation -->
                    ...
                    <div class="panel panel-default">
                        	...
                        	<ul>
                        		<li>
                        			<sec:authorize access="hasRole('ADD_BIN_CAPACITY')">
                        				<a href="././addBinCapacity"><i class="fa fa-table fa-fw"></i> Add Bin Capacity</a>
                        			</sec:authorize>
                        		</li>
                        	</ul>Bin Capacity List
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <form id="showAll">
                             ...
                             <div align="center" style="color:white; background:red;"><b>${duplicateMsg}</b></div>
                                    ...
                                    <tbody>
            							<c:forEach var="row" items="${records}">
											<tr>
												...
												<td>${row.maxBundleCapacity}</td>
												<td><sec:authorize access="hasRole('UPDATE_BIN_CAPACITY')">
														<a href="editBinCapacity?id=${row.id}">Edit</a>
													</sec:authorize></td>
											</tr>
										</c:forEach>
                                    </tbody>
