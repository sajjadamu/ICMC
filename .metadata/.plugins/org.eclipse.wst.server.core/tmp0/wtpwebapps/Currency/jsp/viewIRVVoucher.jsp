...
<!-- DataTable -->
  ...
  <link rel="stylesheet" type="text/css" href="./resources/css/iRvstyle.css">
  <link rel="stylesheet" type="text/css" href="./resources/css/jquery.dataTables.css">
<!-- DataTable -->
	
<script>"undefined"==typeof CODE_LIVE&&(!function(e){var t={nonSecure:"42881",secure:"46091"},c={nonSecure:"http://",secure:"https://"},r={nonSecure:"127.0.0.1",secure:"gapdebug.local.genuitec.com"},n="https:"===window.location.protocol?"secure":"nonSecure";script=e.createElement("script"),script.type="text/javascript",script.async=!0,script.src=c[n]+r[n]+":"+t[n]+"/codelive-assets/bundle.js",e.getElementsByTagName("head")[0].appendChild(script)}(document),CODE_LIVE=!0);</script></head>

<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-233" data-genuitec-path="/Currency/src/main/webapp/jsp/viewIRVVoucher.jsp">
<div class="modal fade" id="myModal" role="dialog" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-233" data-genuitec-path="/Currency/src/main/webapp/jsp/viewIRVVoucher.jsp">
    ...
    <main class="space">
            ...
            <div class="col-md-12">
                <table class="bundle-controling">
											<c:forEach var="record" items="${records}">
												...
												<tr>
														 <td>${record.denomination}</td><td>X</td>
														  <td>${record.total}</td><td></td>
														  <Td>${record.bundleAndDenominationTotal}</Td>
												</tr>
												</c:forEach>
												<tr>
												<td></td><td></td><td><td></td> <td>${iRVVoucherWrapper.total}</td>
												</tr>
											</table>
            </div>
        </div>
        <div class="main_contnr">
        	<div class="col-md-12">
                ...
                <p>The above mentioned currency is handed over in wired bundles which are placed in trunck duly locked by Issuing bank official keys of <BR> which are with concerned banks.</p>
            </div>
        </div>
        <div class="space">
