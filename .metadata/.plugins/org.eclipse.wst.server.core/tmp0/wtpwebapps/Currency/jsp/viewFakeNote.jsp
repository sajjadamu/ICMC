...
<link rel="shortcut icon" href="./resources/logo/favicon.ico" type="image/x-icon">
    <title>ICICI : View Fake Note Data</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-225" data-genuitec-path="/Currency/src/main/webapp/jsp/viewFakeNote.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-225" data-genuitec-path="/Currency/src/main/webapp/jsp/viewFakeNote.jsp">
        <!-- Navigation -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                        	<ul>
                        		<li>
                        			<a href="././fakeNoteEntry"><i  class="fa fa-table fa-fw"></i> Add Fake Note Data</a>
                        		</li>
                        	</ul>List of Fake Notes
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="tableValue">
                                    ...
                                    <thead>
                                       <tr>
											...
											<th>Branch</th>
											<th>Denomination</th>
											<th>Fake Note Serial Number</th>
											<th>CUSTOM_TELLER_CAM</th>
            							...
            							<c:forEach var="row" items="${records}">
											<tr>
											    ...
											    <fmt:formatDate pattern="yyyy-MM-dd"
															value="${row.fakeNoteDate}" />
											    </td>
												<td>${row.solId}</td>
												<td>${row.branch}</td>
												<td>${row.denomination}</td>
												<td>${row.fakeNoteSerialNumber}</td>
												<td>${row.custTellerCam}</td>
												<td>${row.accountNumber}</td>
											    <td><a href="editFakeNote?id=${row.id}">Edit</a></td>
