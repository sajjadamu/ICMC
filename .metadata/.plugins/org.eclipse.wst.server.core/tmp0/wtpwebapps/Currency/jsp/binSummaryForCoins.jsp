...
<body oncontextmenu="return false;" onload="allConverter()"
	data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-68"
	data-genuitec-path="/Currency/src/main/webapp/jsp/binSummaryForCoins.jsp">

	<Table align="center" data-genuitec-lp-enabled="false"
		data-genuitec-file-id="wc1-68"
		data-genuitec-path="/Currency/src/main/webapp/jsp/binSummaryForCoins.jsp">
		<Tr>
			<th style="color: blue; font-size: 150%"><u>Bin Coin Summary</u></th>
		</Tr>
	</Table>
	<BR>
	<div id="converter">
