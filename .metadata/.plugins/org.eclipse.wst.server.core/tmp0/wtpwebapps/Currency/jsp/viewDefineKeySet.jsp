...
<link rel="shortcut icon" href="./resources/logo/favicon.ico" type="image/x-icon">
    <title>ICICI : View Key Set</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-220" data-genuitec-path="/Currency/src/main/webapp/jsp/viewDefineKeySet.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-220" data-genuitec-path="/Currency/src/main/webapp/jsp/viewDefineKeySet.jsp">
        <!-- Navigation -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                        	<ul>
                        		<li>
                        			<sec:authorize access="hasRole('ADD_DEFINE_KEYSET')">
                        				<a href="././DefineKeySet"><i class="fa fa-table fa-fw"></i> Upload Key Set Details</a>
                        			</sec:authorize>
                        		</li>
							</ul>View Key Set Details
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                            <form id="showAll"><div align="center" style="color:green"><b>${uploadMsg}</b></div><br>
                                   ...
                                   <c:forEach var="row" items="${records}">
										<tr>
											...
											<td><sec:authorize access="hasRole('UPDATE_DEFINE_KEYSET')">
													...
													<a href="viewKeySetDetail?custodianId=${row.id}">View Detail</a>
												</sec:authorize>
											</td>
										</tr>
									</c:forEach>
										...
										<%-- <tr>
											<td>CUSTODIAN 1</td>
											<td><sec:authorize access="hasRole('UPDATE_DEFINE_KEYSET')">
													<a href="viewKeySetDetail?custodian=CUSTODIAN 1">View Detail</a>
												</sec:authorize>
											</td>
										</tr>
										...
										<tr>
											<td>CUSTODIAN 2</td>
											<td><sec:authorize access="hasRole('UPDATE_DEFINE_KEYSET')">
													<a href="viewKeySetDetail?custodian=CUSTODIAN 2">View Detail</a>
												</sec:authorize>
											</td>
										</tr> --%>
