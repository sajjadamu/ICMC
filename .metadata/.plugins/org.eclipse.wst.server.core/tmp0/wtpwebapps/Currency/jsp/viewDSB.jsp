...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false"
	data-genuitec-file-id="wc1-218"
	data-genuitec-path="/Currency/src/main/webapp/jsp/viewDSB.jsp">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-heading">
							<ul>
								<li><sec:authorize access="hasRole('ADD_DSB')">
										<a href="././DSB"><i class="fa fa-table fa-fw"></i> Add
											DSB Data</a>
									</sec:authorize></li>
							</ul>
							DSB Data
											...
											<c:forEach var="row" items="${records}">
												<tr>
													...
													<td><sec:authorize access="hasRole('UPDATE_DSB')">
															<a href="editDSB?id=${row.id}">Edit</a>
														</sec:authorize></td>
													<td><a href="rePrintDSBQR?id=${row.id}">Re-print
															QR</a></td>
												</tr>
											</c:forEach>
										</tbody>
