...
<title>ICICI : View DSB Data</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-218" data-genuitec-path="/Currency/src/main/webapp/jsp/viewDSB.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-218" data-genuitec-path="/Currency/src/main/webapp/jsp/viewDSB.jsp">
        <!-- Navigation -->
                        	...
                        	<ul>
                          		<li>
                          			<sec:authorize access="hasRole('ADD_DSB')">
                          				<a href="././DSB"><i class="fa fa-table fa-fw"></i> Add DSB Data</a>
                          			</sec:authorize>
                          		</li>
							</ul>DSB Data
                        </div>
                                    ...
                                    <tbody>
                                    	<c:forEach var="row" items="${records}">
									  		<tr>
												...
												<td>${row.bin}</td>
												<td>${row.status}</td>
												<td><sec:authorize access="hasRole('UPDATE_DSB')">
													<a href="editDSB?id=${row.id}">Edit</a></sec:authorize>
												
												</td>
												<td><a href="rePrintDSBQR?id=${row.id}">Re-print QR</a></td>
											</tr>
										</c:forEach>
                                    </tbody>
                                </table>
