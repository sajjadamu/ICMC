										  ...
										  <td colspan="22" align="left" bgcolor="#e6e6e6">5</td>
											...
											<c:forEach var="row" items="${ibitListValues}">
												...
												<tr>
													...
													<td>${row.denom2Pieces+row.denom5Pieces+row.denom10Pieces+row.denom20Pieces+row.denom50Pieces+row.denom100Pieces+row.denom500Pieces+row.denom1000Pieces+row.denom2000Pieces}</td>
													<td>${row.denom2Pieces*2+row.denom5Pieces*5+row.denom10Pieces*10+row.denom20Pieces*20+row.denom50Pieces*50+row.denom100Pieces*100+row.denom500Pieces*500+row.denom1000Pieces*1000+row.denom2000Pieces*2000}</td>
													<td></td>
													<td></td>
													<td></td>
													<td></td>
											...
											<tr>
												...
												<td><b>${modelMap.totalValueOfBankNotes}</b></td>
												<td><b>0</b></td>
												<td><b>0</b></td>
												<td><b>0</b></td>
												<td><b>0</b></td>
