...
<link rel="shortcut icon" href="./resources/logo/favicon.ico" type="image/x-icon">
    <title>ICICI : CIT/CRA Vendor</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-214" data-genuitec-path="/Currency/src/main/webapp/jsp/viewCITCRAVendor.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-214" data-genuitec-path="/Currency/src/main/webapp/jsp/viewCITCRAVendor.jsp">
        <!-- Navigation -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        	...
                        	<ul>
                        		<li>
                        			<sec:authorize access="hasRole('ADD_CIT_CRA_VENDOR')">
                        				<a href="././CITCRAVendor"><i class="fa fa-table fa-fw"></i> Add CIT/CRA Vendor</a>
                        			</sec:authorize>
                        		</li>
							</ul>List of CIT/CRA Vendor's
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div align="center" style="color:white; background:green;"><b>${removeMsg}</b></div><br>
                                    ...
                                    <tbody>
                                      <c:forEach var="row" items="${records}">
										<tr>
											...
											<td>${row.FPRName}</td>
											<td>${row.FPRNumber}</td>
											<td><sec:authorize access="hasRole('UPDATE_CIT_CRA_VENDOR')">
													<a href="editCITCRAVendor?id=${row.id}">Edit</a></sec:authorize></td>
											<td><sec:authorize access="hasRole('UPDATE_CIT_CRA_VENDOR')">
													<a href="removeCITCRAVendor?id=${row.id}">Remove</a></sec:authorize></td>
										</tr>
									</c:forEach>
                                    </tbody>
                                </table>
