...
<title>ICICI : Add/Upload ICMC/CPC</title>
...
function pageSubmit(){
	alert('ICMC Record submit');
	window.location='././viewICMC';
} 
</script>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-51" data-genuitec-path="/Currency/src/main/webapp/jsp/addICMC.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-51" data-genuitec-path="/Currency/src/main/webapp/jsp/addICMC.jsp">
		<!-- Navigation -->
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<ul>
								<li><a href="././viewICMC"><i class="fa fa-table fa-fw"></i> View List of ICMC's</a></li>
							</ul>Add/Upload ICMC/CPC
						</div>
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-6">
									<!--<form role="form">-->
									<form:form id="userPage" name="userPage" action="saveICMC" method="post"
										modelAttribute="user" enctype="multipart/form-data" autocomplete="off">
										
										<div align="center" style="color: red"><b>${duplicateICMC}</b></div>
										...
										<div class="form-group">
											...
											<form:input path="linkBranchSolId" id="linkBranchSolId" name="linkBranchSolId" maxlength="4"
												cssClass="form-control" onkeyup="doAjaxForRBINameZoneAndRegion()"/>
										</div>
										...
										<div class="form-group js-rbi">
											...
											<form:select path="rbiName" id="rbiName" name="rbiName" cssClass="form-control"
										...
										<div class="form-group">
											...
											<form:input path="chestCode" id="chestCode" name="chestCode" maxlength="50"
												cssClass="form-control" />
										</div>
										...
										<div class="col-lg-6 form-group">
											...
											<a href="${documentFilePath}/ICMC.csv" download>Download CSV Format</a>
										</div>
	  ...
	  $("form[name='userPage']").validate({
	    ...
	    messages: {
	    	...
	    	linkBranchSolId: {
             ...
             chestCode: {
            	 loginRegexAddress:"This special character is not allowed",
 	    		required:"Please enter chestCode",
 	    		maxlength:"chestCode can't have more than 45 characters",
 	    	 },
