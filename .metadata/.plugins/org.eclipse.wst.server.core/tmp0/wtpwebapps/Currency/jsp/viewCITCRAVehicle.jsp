...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-213" data-genuitec-path="/Currency/src/main/webapp/jsp/viewCITCRAVehicle.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-213" data-genuitec-path="/Currency/src/main/webapp/jsp/viewCITCRAVehicle.jsp">
        <!-- Navigation -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        	...
                        	<ul>
                        		<li>
                        			<sec:authorize access="hasRole('ADD_CIT_CRA_VEHICLE')">
                        				<a href="././CITCRAVehicle"><i class="fa fa-table fa-fw"></i> Add CIT/CRA Vehicle</a>
                        			</sec:authorize>
                        		</li>
							</ul>List of CIT/CRA Vehicle's
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div align="center" style="color: green"><b>${uploadMsg}</b></div>
                            <div align="center" style="color: green"><b>${updateMsg}</b></div>
                            <div align="center" style="color: green"><b>${removeMsg}</b></div>
                                    ...
                                    <tbody>
                                      <c:forEach var="row" items="${records}">
										<tr>
											<td>${row.name}</td>
											<td>${row.number}</td>
											<td><fmt:formatDate pattern="dd-MMM-yy"  value="${row.boughtDate}" /></td>
											<td>${row.regCityName}</td>
											<td>${row.insurance}</td>
											<td><fmt:formatDate pattern="dd-MMM-yy"  value="${row.fitnessExpiryDate}" /></td>
											<td><fmt:formatDate pattern="dd-MMM-yy"  value="${row.pollutionExpiryDate}" /></td>
											<td><fmt:formatDate pattern="dd-MMM-yy"  value="${row.permitDate}" /></td>
											<td><sec:authorize access="hasRole('UPDATE_CIT_CRA_VEHICLE')">
													<a href="editCITCRAVehicle?id=${row.id}">Edit</a></sec:authorize></td>
											<td><sec:authorize access="hasRole('UPDATE_CIT_CRA_VEHICLE')">
													<a href="removeCITCRAVehicle?id=${row.id}">Remove</a></sec:authorize></td>
										</tr>
									</c:forEach>
                                   </tbody>
                                </table>
