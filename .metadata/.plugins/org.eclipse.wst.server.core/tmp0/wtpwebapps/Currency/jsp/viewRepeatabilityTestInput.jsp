...
<link rel="shortcut icon" href="./resources/logo/favicon.ico" type="image/x-icon">
    <title>ICICI : Repeatability Test Input</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-254" data-genuitec-path="/Currency/src/main/webapp/jsp/viewRepeatabilityTestInput.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-254" data-genuitec-path="/Currency/src/main/webapp/jsp/viewRepeatabilityTestInput.jsp">
        <!-- Navigation -->
                        	...
                        	<ul>
                        		<li>
                        			<sec:authorize access="hasRole('ADD_REPEATABILITY_TEST_INPUT')">
                        				<a href="././RepeatabilityTestInput"><i
											class="fa fa-table fa-fw"></i> Add Repeatability Test Input</a>
									</sec:authorize>
								</li>
							</ul>Repeatability Test Input Details
                        </div>
                        <!-- /.panel-heading -->
                                    ...
                                    <tbody><%!int i=0; %>
                                    	<c:forEach var="row" items="${records}">
											<tr><%i++; %>
												...
												<td>${row.binNo}</td>
												<td><sec:authorize access="hasRole('UPDATE_REPEATABILITY_TEST_INPUT')">
														<a href="editRepeatabilityTestInput?id=${row.id}">Edit</a>
													</sec:authorize>
												</td>
											</tr>
										</c:forEach><%i=0 ;%>
