...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-232" data-genuitec-path="/Currency/src/main/webapp/jsp/viewIRV.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-232" data-genuitec-path="/Currency/src/main/webapp/jsp/viewIRV.jsp">
        <!-- Navigation -->
                ...
                <div class="col-lg-13">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          <ul>
                          <li><a href="././IRVVoucher"><i
								class="fa fa-table fa-fw"></i> IRV Voucher</a></li>
                          <li><a href="././IRV"><i
								class="fa fa-table fa-fw"></i> Add IRV Data</a></li></ul>
                         IRV Data List
                        </div>
                        <!-- /.panel-heading -->
