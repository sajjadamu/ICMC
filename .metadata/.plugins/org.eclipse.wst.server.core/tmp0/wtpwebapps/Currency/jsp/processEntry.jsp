...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-173" data-genuitec-path="/Currency/src/main/webapp/jsp/processEntry.jsp">

	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-173" data-genuitec-path="/Currency/src/main/webapp/jsp/processEntry.jsp">
		<!-- Navigation -->
									...
									<form:form id="processEntry" name="processEntry" action="#"
										...
										<div class="form-group">
											<label>Cash Processed By</label><br>
												<form:radiobuttons items="${processActionList}" path="processAction" 
														id="processAction" name="processAction" />
										</div>
