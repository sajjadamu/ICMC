...
function replicateValue(i){
	...
	'<td width="22%"><input type="text" id="Denomination'+countrow+'" class="form-control input-margin" name="Denomination" value="'+denomData+'" autofocus></td>'+
...
function addRow(i){
	...
	i++;
	var data= '<tr id="main'+countrow+'">'+
	'<td width="22%"><input type="text" id="Denomination'+countrow+'" class="form-control input-margin" name="Denomination" value="" autofocus></td>'+
...
function getFakeNotePrintYear(i) {
    ...
    if(dis == 'FAKE'){
        $("#printYear"+i).removeAttr('disabled');
        $("#NumberOfNotes"+i).attr('disabled', 'disabled');
       }else{
        $("#printYear"+i).attr('disabled', 'disabled');
        $("#NumberOfNotes"+i).removeAttr('disabled');
    }
}
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-90" data-genuitec-path="/Currency/src/main/webapp/jsp/discrepancy.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-90" data-genuitec-path="/Currency/src/main/webapp/jsp/discrepancy.jsp">
		<!-- Navigation -->
