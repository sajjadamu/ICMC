...
<title> Edit Assign Vault Custodian</title>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Modify Assign Vault Custodian</div>
...
$.validator.addMethod("loginRegexlicNum", function(value, element) {
	...
	$(function() {
	  $("form[name='userPage']").validate({
	    ...
	    messages: {
	    	userId: {
	    		loginRegexlicNum:"Only Numeric Value Accepted",
	    		required:"Please Enter User Id.",
		   		rangelength:  "User Id can't have more than  45 character "
	    	},
	    	keySet:{
	    		required:"Please Select Custodian",
		   		rangelength:  "Custodian can't have more than  45 character "
	    	} ,
