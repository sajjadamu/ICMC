...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-28" data-genuitec-path="/Currency/src/main/webapp/jsp/MachineDowntimeUpdation.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-28" data-genuitec-path="/Currency/src/main/webapp/jsp/MachineDowntimeUpdation.jsp">
		<!-- Navigation -->
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
	                        <ul>
	                        	<li>
	                        		<a href="././viewMachineDownTime"><i class="fa fa-table fa-fw"></i> View Machine Downtime Details</a>
	                        	</li>
							</ul>Add Machine Downtime
                        </div>
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-6">
									<!--<form role="form">-->
									<form:form id="userPage" name="userPage" action="AddMachineDowntimeUpdation" method="post"
                                       ...
                                       <fmt:formatDate var="nowDate"  value="${now}" pattern="yyyy-MM-dd" />
										...
										<div class="form-group">
											...
											<form:input path="machineDownDateFrom" id="machineDownDateFrom" name="machineDownDateFrom" cssClass="form-control" />
										</div>
										...
										<div class="form-group">
											...
											<form:radiobuttons items="${machineList}" itemLabel="machineNo"  itemValue="machineNo" path="machineNo" id="machineNo" name="machineNo" />
										</div> 
