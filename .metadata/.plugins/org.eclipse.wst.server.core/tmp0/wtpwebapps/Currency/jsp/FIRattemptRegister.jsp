...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-22" data-genuitec-path="/Currency/src/main/webapp/jsp/FIRattemptRegister.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-22" data-genuitec-path="/Currency/src/main/webapp/jsp/FIRattemptRegister.jsp">
		<!-- Navigation -->
								...
								<div class="containerr" id="printableArea">
									...
									<table width="100%">
										...
										<tr class="eqq-con bb">
											...
											<td class="eqquall">Name and Address of the Police station</td>
											<td class="eqquall">ICMC Officer who visited the Police station</td>
