...
<link rel="shortcut icon" href="./resources/logo/favicon.ico" type="image/x-icon">
    <title>ICICI : View Fresh Currency</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-266" data-genuitec-path="/Currency/src/main/webapp/jsp/viewfreshCurrency.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-266" data-genuitec-path="/Currency/src/main/webapp/jsp/viewfreshCurrency.jsp">
        <!-- Navigation -->
                        	...
                        	<ul>
                        		<li>
                        			<sec:authorize access="hasRole('ADD_FRESH_CURRENCY')">
                        				<a href="././FreshCurrency"><i class="fa fa-table fa-fw"></i> Add Fresh Currency</a>
                        			</sec:authorize>
                        		</li>
							</ul>Fresh Currency Details
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                            <form id="showAll"><div align="center" style="color:white;background:green"><b>${successMsg}</b></div><br>
                                 	...
                                 	<tbody><%!int i=0; %>
	                                    <c:forEach var="row" items="${records}">
											<tr><%i++; %>
												...
												<td><sec:authorize access="hasRole('UPDATE_FRESH_CURRENCY')">
														<a href="editFreshCurrency?id=${row.id}">Edit</a>
													</sec:authorize>
												</td>
											</tr>
										</c:forEach><%i=0 ;%>
