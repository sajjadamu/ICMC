...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false"
	data-genuitec-file-id="wc1-172"
	data-genuitec-path="/Currency/src/main/webapp/jsp/printerSetting.jsp">
							...
							<div class="row">
								<div class="col-lg-6">
									...
									<form:form id="userPage" name="userPage"
										action="updatePrinterSetting" method="post"
										modelAttribute="icmcPrinter" enctype="multipart/form-data"
										autocomplete="off">

										<div class="form-group">
											<label>ICMC Printer</label>
											<form:select path="printerName" id="printerName"
