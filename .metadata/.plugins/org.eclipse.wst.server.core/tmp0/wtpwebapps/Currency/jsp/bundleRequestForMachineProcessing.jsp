...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-72" data-genuitec-path="/Currency/src/main/webapp/jsp/bundleRequestForMachineProcessing.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-72" data-genuitec-path="/Currency/src/main/webapp/jsp/bundleRequestForMachineProcessing.jsp">
        <!-- Navigation -->
