...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-187" data-genuitec-path="/Currency/src/main/webapp/jsp/returnBackToVault.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-187" data-genuitec-path="/Currency/src/main/webapp/jsp/returnBackToVault.jsp">
		<!-- Navigation -->
										...
										<tbody>
											<c:forEach var="row" items="${branchBundleReturned}">
												...
												<tr>
													...
													<td><input type="button" value="ReturnBackToVault" onclick="doAjaxPostForSaveAndPrintBranch('${count}<%=CashSource.BRANCH%>','<%=CashSource.BRANCH%>','${row.denomination}')"></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
										...
										<tbody>
											<c:forEach var="row" items="${dsbBundleReturned}">
												...
												<tr>
													...
													<td><input type="button" value="ReturnBackToVault" onclick="doAjaxPostForSaveAndPrintDSB('${count}<%=CashSource.DSB%>','<%=CashSource.DSB%>','${row.denomination}')" ></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
										...
										<tbody>
											<c:forEach var="row" items="${otherBankBundleReturned}">
												...
												<tr>
													...
													<td><input type="button" value="ReturnBackToVault" onclick="doAjaxPostForSaveAndPrintOtherBank('${count}<%=CashSource.OTHERBANK%>','<%=CashSource.OTHERBANK%>','${row.denomination}')"></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
										...
										<tbody>
											<c:forEach var="row" items="${diversionBundleReturned}">
												...
												<tr>
													...
													<td><input type="button" value="ReturnBackToVault" onclick="doAjaxPostForSaveAndPrintDiversion('${count}<%=CashSource.DIVERSION%>','<%=CashSource.DIVERSION%>','${row.denomination}')"></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
