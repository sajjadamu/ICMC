...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false"
	data-genuitec-file-id="wc1-44"
	data-genuitec-path="/Currency/src/main/webapp/jsp/acceptIndent.jsp">

	<div class="modal fade" id="myModal" role="dialog"
		data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-44"
		data-genuitec-path="/Currency/src/main/webapp/jsp/acceptIndent.jsp">
												...
												<tr id="xy${row.bin}">
													...
													<td><sec:authorize access="hasRole('ACCEPT_INDENT')">
															<input type="button" value="Accept"
																onclick="doAjaxPostUpdateStatus('${row.bin}')">
														</sec:authorize></td>
												</tr>
											</c:forEach>
										</tbody>
