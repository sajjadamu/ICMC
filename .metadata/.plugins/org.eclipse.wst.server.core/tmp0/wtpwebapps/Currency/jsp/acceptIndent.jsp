...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-44" data-genuitec-path="/Currency/src/main/webapp/jsp/acceptIndent.jsp">

<div class="modal fade" id="myModal" role="dialog" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-44" data-genuitec-path="/Currency/src/main/webapp/jsp/acceptIndent.jsp">
										...
										<tr id="xy${row.bin}">
											...
											<td id="bin${row.bin}">${row.bin}</td>
											 ...
											 <td><sec:authorize access="hasRole('VIEW_INDENT')">
											 		<a href="#" onclick="ajaxViewBinDetail('${row.denomination}','${row.bin}')">View Bin Detail </a>
											 	 </sec:authorize></td>
											 
											 <td><sec:authorize access="hasRole('ACCEPT_INDENT')">
											 		<input type="button" value="Accept" onclick="doAjaxPostUpdateStatus('${row.bin}')">
											 	 </sec:authorize></td>
										</tr>
									</c:forEach>
                                    </tbody>
