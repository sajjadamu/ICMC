...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false"
	data-genuitec-file-id="wc1-175"
	data-genuitec-path="/Currency/src/main/webapp/jsp/processingRoomSummary.jsp">

	<Table align="center" data-genuitec-lp-enabled="false"
		data-genuitec-file-id="wc1-175"
		data-genuitec-path="/Currency/src/main/webapp/jsp/processingRoomSummary.jsp">
		<Tr>
			<th style="color: blue; font-size: 150%"><u>Processing Room
					Summary</u></th>
		</Tr>
	</Table>
	<BR>
