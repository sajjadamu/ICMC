...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-243" data-genuitec-path="/Currency/src/main/webapp/jsp/viewMachineSoftware.jsp">

    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-243" data-genuitec-path="/Currency/src/main/webapp/jsp/viewMachineSoftware.jsp">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                        	<ul>
                        		<li>
                        			<sec:authorize access="hasRole('ADD_MACHINE_SOFTWARE_UPDATION')">
                        				<a href="././MachineSoftwareUpdation"><i 
                        					class="fa fa-table fa-fw"></i> Add Machine Software Updation Details</a>
                        			</sec:authorize>
                        		</li>
							</ul>Machine Software Updation Details
                        </div>
                                    ...
                                    <tbody><%!int i=0; %>
                                      <c:forEach var="row" items="${records}">
										<tr><%i++; %>
											<td><%=i %></td>
											<td>${row.region}</td>
											<td><fmt:formatDate pattern="yyyy-MM-dd"  value="${row.softwareUpdationDate}" /></td>
											<td>${row.softwaredetails}</td>
											<td><sec:authorize access="hasRole('UPDATE_MACHINE_SOFTWARE_UPDATION')">
													<a href="editMachineSoftware?id=${row.id}">Edit</a>
												</sec:authorize>
											</td>
										</tr>
									</c:forEach><%i=0 ;%>
