...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-221" data-genuitec-path="/Currency/src/main/webapp/jsp/viewDelegateRight.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-221" data-genuitec-path="/Currency/src/main/webapp/jsp/viewDelegateRight.jsp">
        <!-- Navigation -->
                        	...
                        	<ul>
                          		<li>
                          			<sec:authorize access="hasRole('ADD_DELEGATE_RIGHT')">
                          				<a href="././addDelegateRight"><i class="fa fa-table fa-fw"></i> Add Delegate Right</a>
                          			</sec:authorize>
                          		</li>
							</ul>List of Delegated Rights
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="tableValue">
                                    ...
                                    <c:forEach var="row" items="${records}">
										<tr>
											<td>${row.userId}</td>
											<td>${row.role.id}</td>
											<td><fmt:formatDate pattern="dd-MMM-yy"  value="${row.periodFrom}" /></td>
											<td><fmt:formatDate pattern="dd-MMM-yy"  value="${row.periodTo}" /></td>
											<td><sec:authorize access="hasRole('UPDATE_DELEGATE_RIGHT')">
													<a href="editDelegateRight?id=${row.id}">Edit</a></sec:authorize></td>
										</tr>
									</c:forEach>
                                    </tbody>   
                   				</table>
