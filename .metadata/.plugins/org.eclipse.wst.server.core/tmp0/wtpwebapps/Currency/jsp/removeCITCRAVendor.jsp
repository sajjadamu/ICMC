...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-180" data-genuitec-path="/Currency/src/main/webapp/jsp/removeCITCRAVendor.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-180" data-genuitec-path="/Currency/src/main/webapp/jsp/removeCITCRAVendor.jsp">
		<!-- Navigation -->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Remove Vendor</div>
							...
							<div class="row">
								<div class="col-lg-6">
									...
									<form:form id="userPage" name="userPage" action="removeVendor" method="post"
										...
										<form:hidden path="typeThree" />
										<form:hidden path="FPRName" />
										<form:hidden path="FPRNumber" />
