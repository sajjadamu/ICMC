...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-199" data-genuitec-path="/Currency/src/main/webapp/jsp/viewAll.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-199" data-genuitec-path="/Currency/src/main/webapp/jsp/viewAll.jsp">
        <!-- Navigation -->
                        	...
                        	<ul>
                        		<li>
                        			<sec:authorize access="hasRole('ADD_USER')">
                        				<a href="././addUser"><i class="fa fa-table fa-fw"></i> Add User</a>
                        			</sec:authorize>
                        		</li>
                        	</ul>Users List
                        </div>
											...
											<tr>
												...
												<td>${row.status}</td>
					 							<td><sec:authorize access="hasRole('UPDATE_USER')">
					 									<a href="editUser?id=${row.id}">Edit</a></sec:authorize></td>
											</tr>
										</c:forEach>
                                    </tbody>
                                </table>
