...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-127" data-genuitec-path="/Currency/src/main/webapp/jsp/editPrinter.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-127" data-genuitec-path="/Currency/src/main/webapp/jsp/editPrinter.jsp">
		<!-- Navigation -->
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-6">
									<!--<form role="form">-->
									<form:form id="userPage" name="userPage" action="updatePrinter" method="post" 
										modelAttribute="icmcPrinter" autocomplete="off">
										
										<form:hidden path="id"/>
										
										<div class="form-group">
											<label>Printer Name</label>
											 <form:input path="printerName" id="printerName" name="printerName" cssClass="form-control" maxlength="32" readonly="true" />
										</div>
										...
										<div class="form-group">
											<label>Port</label>
											 <form:input path="port" id="port" name="port" maxlength="6" cssClass="form-control"/>
										</div>
