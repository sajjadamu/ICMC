...
<link rel="shortcut icon" href="./resources/logo/favicon.ico" type="image/x-icon">
    <title>ICICI : View Key Set Detail</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-236" data-genuitec-path="/Currency/src/main/webapp/jsp/viewKeySetDetail.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-236" data-genuitec-path="/Currency/src/main/webapp/jsp/viewKeySetDetail.jsp">
        <!-- Navigation -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                           <div class="panel-heading">
							...
							</ul>View Key Set Details for Selected Custodian
                        </div>
                        <!-- /.panel-heading -->
