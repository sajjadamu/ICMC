...
<link rel="shortcut icon" href="./resources/logo/favicon.ico"
	type="image/x-icon">
<title>ICICI : View ICMC/CPC</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-230" data-genuitec-path="/Currency/src/main/webapp/jsp/viewICMC.jsp">

	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-230" data-genuitec-path="/Currency/src/main/webapp/jsp/viewICMC.jsp">
					...
					<div class="panel panel-default">
							...
							<ul>
								<li>
									<sec:authorize access="hasRole('ADD_ICMC')">
										<a href="././addICMC"><i class="fa fa-table fa-fw"></i> Add/Upload ICMC/CPC</a>
									</sec:authorize>
								</li>
							</ul>List of ICMC's
						</div>
						...
						<div class="panel-body">
							<div class="dataTable_wrapper">
								...
								<div align="center" style="color:white; background:green;"><b>${icmcRemovalSuccessMsg}</b></div><br>
										...
										<tbody>
											<c:forEach var="row" items="${records}">
												<tr>
													...
													<td>${row.pincode}</td>
													<td>${row.status}</td>
													<td><sec:authorize access="hasRole('UPDATE_ICMC')">
															<a href="editICMC?id=${row.id}">Edit</a>
														</sec:authorize>
													</td>
													<td><sec:authorize access="hasRole('UPDATE_ICMC')">
															<a href="removeICMC?id=${row.id}">Remove</a>
														</sec:authorize>
													</td>
												</tr>
											</c:forEach>
