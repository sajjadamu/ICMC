...
<link rel="shortcut icon" href="./resources/logo/favicon.ico" type="image/x-icon">
    <title>ICICI : Repeatability Test Output</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-255" data-genuitec-path="/Currency/src/main/webapp/jsp/viewRepeatabilityTestOutput.jsp">

    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-255" data-genuitec-path="/Currency/src/main/webapp/jsp/viewRepeatabilityTestOutput.jsp">
                        	...
                        	<ul>
                        		<li>
                        			<sec:authorize access="hasRole('ADD_REPEATABILITY_TEST_OUTPUT')">
	                        			<a href="././RepeatabilityTestOutput"><i
											class="fa fa-table fa-fw"></i> Add Repeatability Test Output Details</a>
									</sec:authorize>
								</li>
							</ul>Repeatability Test Output Details
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                            <form id="showAll"><div align="center" style="color:white; background:green;"><b>${successMsg}</b></div>
                                    ...
                                    <tbody><%!int i=0; %>
                                    	<c:forEach var="row" items="${records}">
											<tr><%i++; %>
												...
												<td>${row.binNo}</td>
												<td><sec:authorize access="hasRole('UPDATE_REPEATABILITY_TEST_OUTPUT')">
														<a href="editRepeatabilityTestOutput?id=${row.id}">Edit</a>
													</sec:authorize>
												</td>
											</tr>
										</c:forEach><%i=0 ;%>
