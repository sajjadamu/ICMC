  	...
  	//  alert(bundle)
  	 ...
  	 // var status=$('#status'+str+' :checked').val();
  	  ...
  	  contentType : 'application/json; charset=utf-8',
  	    url: "././auditorIndentAccept",
  	  data: JSON.stringify(auditorIndentAccept),
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-42" data-genuitec-path="/Currency/src/main/webapp/jsp/acceptAuditorIndent.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-42" data-genuitec-path="/Currency/src/main/webapp/jsp/acceptAuditorIndent.jsp">
        <!-- Navigation -->
                                    ...
                                    <tbody>
                                      <c:forEach var="row" items="${records}">
										<tr id="xy${row.id}">
											...
											<td>${row.binType}</td>
											<td><input type="button" value="ACCEPT" onclick="doAjaxPostUpdateStatus(${row.id})"></td>
										</tr>
									  </c:forEach>
                                    </tbody>
                                </table>
