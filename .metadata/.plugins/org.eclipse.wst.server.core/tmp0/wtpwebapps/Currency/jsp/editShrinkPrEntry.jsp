...
<title> Edit Branch Receipt</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false"
	data-genuitec-file-id="wc1-134"
	data-genuitec-path="/Currency/src/main/webapp/jsp/editShrinkPrEntry.jsp">
							...
							<div class="row">
								<div class="col-lg-8">
									...
									<form:form id="" action="" method="post" modelAttribute="user"
										...
										<div class="form-group">
											<label>Packet</label>
											<form:input path="bundle" value="${packets}" id="bundle"
