...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-202" data-genuitec-path="/Currency/src/main/webapp/jsp/viewBankReceipt.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-202" data-genuitec-path="/Currency/src/main/webapp/jsp/viewBankReceipt.jsp">
        <!-- Navigation -->
                        	...
                        	<ul>
                        		<li>
                        			<sec:authorize access="hasRole('ADD_OTHER_BANK_RECEIPT')">
                        				<a href="././AddOtherBankReceipt"><i class="fa fa-table fa-fw"></i> Add Other Bank Receipt</a>
                        			</sec:authorize>
								</li>
							</ul>Other Bank Receipt Data
                        </div>
                        <!-- /.panel-heading -->
                                    ...
                                    <tbody>
                                      <c:forEach var="row" items="${records}">
										<tr>
											...
											<td>${row.total}</td>
											<td>${row.binNumber}</td>
											<td><sec:authorize access="hasRole('UPDATE_OTHER_BANK_RECEIPT')">
												<a href="editOtherBank?id=${row.id}">Edit</a>
												
												</sec:authorize>
											</td>
											<td><a href="rePrintBankQR?id=${row.id}">Re-print QR</a></td>
										</tr>
									</c:forEach>
                                    </tbody>
                                </table>
