...
<style type="text/css">
.panel.panel-default .btn-success {margin-top: 20px; position: absolute; right: 20px; font-size: 14px; 
width: 82px; background: #d85600; padding: 7px; top: -15px;
}
</style>
<!-- Bootstrap Core CSS -->
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-86" data-genuitec-path="/Currency/src/main/webapp/jsp/dailyBinRecon.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-86" data-genuitec-path="/Currency/src/main/webapp/jsp/dailyBinRecon.jsp">
		<!-- Navigation -->
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="panel panel-default">
						...
						<ul>
							<li>
							<form:form id="user" name="user" action="saveDataInBinTransactionBOD" method="post">
					...
					<input type="button" class="btn btn-default qr-button" onclick="printDiv('printableArea')" value="Print" />
						...
						<div align="center" style="color:white; background:green;"><b>${successMsgForEOD}</b></div>
						<!-- /.panel-heading -->
									...
									<table class="table table-striped table-bordered table-hover"  id="tableValue">
										...
										<tbody>
											...
											<td id="id${row.id}" style="display:none;">${row.id}</td>
													...
													<Td><input readonly="readonly" type="text" id="message${row.id}"></Td>
												</tr>
												</c:forEach>
										</tbody>
									</table>
