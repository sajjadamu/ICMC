...
<script type="text/javascript">
	function pageSubmit() {
		alert('SAS File Uploaded Successfully');
		window.location = '././SAS';
	}
</script>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-41" data-genuitec-path="/Currency/src/main/webapp/jsp/UploadSAS.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-41" data-genuitec-path="/Currency/src/main/webapp/jsp/UploadSAS.jsp">
		<!-- Navigation -->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">SAS Upload</div>
