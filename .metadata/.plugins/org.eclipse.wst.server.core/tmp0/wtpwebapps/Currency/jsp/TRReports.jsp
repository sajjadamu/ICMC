...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-40" data-genuitec-path="/Currency/src/main/webapp/jsp/TRReports.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-40" data-genuitec-path="/Currency/src/main/webapp/jsp/TRReports.jsp">
		<!-- Navigation -->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">TR64 Reports</div>
						<!-- /.panel-heading -->
						...
						<div class="panel-body">
						 ...
						 <div class="region-con">
								<form:form id="userPage" name="userPage" action="TRReports" method="post" modelAttribute="reportDate" autocomplete="off">
							...
							<div>
								...
								<!-- <table class="table table-striped table-bordered table-hover" id="dataTables-example"> -->
											...
											<tbody class="table table-striped table-bordered table-hover">
												<c:forEach var="row" items="${trReports}">
												<c:set var="count" value="${count+1}" scope="page"/>
													<tr>
														<td>${count}</td>
														<td>${row.weight}</td>
														<td>${row.denomination}</td>
														<td>${row.bundle*1000}</td>
														<td>${row.denomination*row.bundle*1000}</td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
