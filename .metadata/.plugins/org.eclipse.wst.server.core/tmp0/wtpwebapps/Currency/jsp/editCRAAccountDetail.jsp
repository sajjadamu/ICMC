...
<title>ICICI : Update CRA Account Detail</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-104" data-genuitec-path="/Currency/src/main/webapp/jsp/editCRAAccountDetail.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-104" data-genuitec-path="/Currency/src/main/webapp/jsp/editCRAAccountDetail.jsp">
		<!-- Navigation -->
							...
							<ul>
								<li>
									<sec:authorize access="hasRole('VIEW_CRA_ACCOUNT')">
										<a href="././viewCRAAccountDetail"><i class="fa fa-table fa-fw"></i> View CRA Account Details</a>
									</sec:authorize>
								</li>
							</ul>Update CRA Account Details
						</div>
