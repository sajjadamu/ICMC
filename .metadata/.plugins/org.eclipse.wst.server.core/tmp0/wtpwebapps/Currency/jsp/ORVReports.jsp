...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-32" data-genuitec-path="/Currency/src/main/webapp/jsp/ORVReports.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-32" data-genuitec-path="/Currency/src/main/webapp/jsp/ORVReports.jsp">
		<!-- Navigation -->
							...
							<div class="dataTable_wrapper">
								...
								<div id="printableArea">
								 <div id="table_wrapper">
										...
										<tbody>
											...
											<c:forEach var="row" items="${craRecords}">
												...
												<tr>
													<td>${count}</td>
													<td>${row.solId}</td>
													<td>${row.branch} - ${row.vendor} - ${row.mspName} </td>   <!-- Show Vendor Name as well as MSP Name alongwith Branch Name -->
									...
									<table class="table table-striped table-bordered table-hover" id="tableValue">
									<Tr><td style="widh:4px;">${servicingICMC} - Processing</td>
									...
									<Tr><td>Branch and Processing</td>
									<td></td>
									<td></td>
									<td><b>Total</b></td>
