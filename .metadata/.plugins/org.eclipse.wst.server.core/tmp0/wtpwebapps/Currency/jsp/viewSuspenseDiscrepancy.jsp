...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-260" data-genuitec-path="/Currency/src/main/webapp/jsp/viewSuspenseDiscrepancy.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-260" data-genuitec-path="/Currency/src/main/webapp/jsp/viewSuspenseDiscrepancy.jsp">
        <!-- Navigation -->
                        	...
                        	<ul>
                        		<li>
                        			<sec:authorize access="hasRole('ADD_DISCREPANCY')">
                        				<a href="././addSuspenseDiscrepancy"><i class="fa fa-table fa-fw"></i> Add Suspense Discrepancy</a>
                        			</sec:authorize>
                        		</li>
							</ul>Suspense Discrepancy Data
                        </div>
                        <!-- /.panel-heading -->
                                    	...
                                    	<c:forEach var="row" items="${records}">
												<tr>
													...
													<td>${row.accountNumber}</td>
													 ...
													 <Td>
													 <a href="editSuspenseDiscrepancy?allocationId=${row.id}">Edit</a>
													 </Td>
