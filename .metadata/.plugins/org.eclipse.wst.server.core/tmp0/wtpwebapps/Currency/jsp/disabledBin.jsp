...
<head>
    ...
    <title>ICICI : Disabled Bin List</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-88" data-genuitec-path="/Currency/src/main/webapp/jsp/disabledBin.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-88" data-genuitec-path="/Currency/src/main/webapp/jsp/disabledBin.jsp">
        <!-- Navigation -->
                                    ...
                                    <tbody>
                                      <c:forEach var="row" items="${records}">
										<tr>
											<td>${row.binNumber}</td>
											<td>
											<a href="editDisabledBin?id=${row.id}">Edit</a>
											</td>
										</tr>
									  </c:forEach>
                                    </tbody>
