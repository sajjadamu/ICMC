...
<link rel="shortcut icon" href="./resources/logo/favicon.ico" type="image/x-icon">
    <title>ICICI : View CRA Account Detail</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-216" data-genuitec-path="/Currency/src/main/webapp/jsp/viewCRAAccountDetail.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-216" data-genuitec-path="/Currency/src/main/webapp/jsp/viewCRAAccountDetail.jsp">
        <!-- Navigation -->
                        	...
                        	<ul>
                          		<li>
                          			<sec:authorize access="hasRole('ADD_CRA_ACCOUNT')">
                          				<a href="././addCRAAccountDetail"><i class="fa fa-table fa-fw"></i> Add CRA Account Detail</a>
                          			</sec:authorize>
                          		</li>
							</ul>View CRA Account Details
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="tableValue">
                                    ...
                                    <tbody>
                                    	<c:forEach var="row" items="${records}">
									  		<tr>
												<td>${row.craVendorName}</td>
												<td>${row.mspName}</td>
												<td>${row.accountNumber}</td>
												<td>
													<sec:authorize access="hasRole('UPDATE_CRA_ACCOUNT')">
														<a href="editCRAAccountDetail?id=${row.id}">Edit</a>
													</sec:authorize>
												</td>
											</tr>
										</c:forEach>
