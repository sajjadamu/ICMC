...
<link rel="shortcut icon" href="./resources/logo/favicon.ico" type="image/x-icon">
    <title>ICICI : View Suspense Opening Balance</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-261" data-genuitec-path="/Currency/src/main/webapp/jsp/viewSuspenseOpeningBalance.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-261" data-genuitec-path="/Currency/src/main/webapp/jsp/viewSuspenseOpeningBalance.jsp">
        <!-- Navigation -->
                                    ...
                                    <tbody>
            							<c:forEach var="row" items="${records}">
											...
											<td><fmt:formatDate pattern="yyyy-MM-dd"  value="${row.insertTime.time}" /></td>
												<td>${row.denomination2000}</td>
												<td>${row.denomination1000}</td>
												<td>${row.denomination500}</td>
												<td>${row.denomination200}</td>
												<td>${row.denomination100}</td>
												<td>${row.denomination50}</td>
												<td>${row.denomination20}</td>
												<td>${row.denomination10}</td>
												<td>${row.denomination5}</td>
												<td>${row.denomination2}</td>
												<td>${row.denomination1}</td>
											</tr>
										</c:forEach>
                                    </tbody>
                                </table>
