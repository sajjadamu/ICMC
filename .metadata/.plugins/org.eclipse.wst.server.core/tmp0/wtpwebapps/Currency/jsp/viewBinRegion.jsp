...
<link rel="stylesheet" type="text/css"
	...
	div.panel-default {border-radius:0 !important;}
	.panel-heading {overflow:hidden; background: #F5F5F5;}
	.collapse .panel-default {background:none; border:none;}
	div.DesabilityContr div.panel-heading {background:none; padding: 10px 0;}

	.zone_Contnr1 {padding: 0 !important; border: 1px solid #ddd;}
	.zone_Contnr1 > h3 {background: #053C6D; margin: 0; text-align: center; color: #fff; font-size: 14px; font-weight: 700; padding: 20px;}
	.zone_Contnr1>p{border:1px solid #ddd; padding:8px; font-weight:normal;text-align:center; font-size:14px;}
	.zone_Contnr1>p>a {display:block;}
	.zone_Contnr1 label:last-child {border: none; font: normal;}
	.panel-heading table>thead {background: #053C6D; color: #fff;}
	
	.panel-group .panel + .panel {border:none; margin-top: 0;}
	.panel-group .panel + .panel > div {border:1px solid #ddd; border-top:0;}
	
	.collapse .panel-heading {border:1px solid #ddd; border-radius: 0;}
	.table-bordered>tbody>tr>td:nth-child(1) {width: 26%;}
	.table-bordered>tbody>tr>td:nth-child(2) {width: 26.5%;}
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-208" data-genuitec-path="/Currency/src/main/webapp/jsp/viewBinRegion.jsp">

	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-208" data-genuitec-path="/Currency/src/main/webapp/jsp/viewBinRegion.jsp">
		<!-- Navigation -->
  ...
  <div class="panel panel-default1">
    				<div class="panel-heading">
    										...
    										<c:forEach  var="regionValue" items="${regionList}">
    												<p class="panel-title">
        											<a data-toggle="collapse" data-parent="#accordion" href="#${regionValue}">${regionValue}</a>
        											 </p>
