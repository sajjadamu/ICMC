...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-65" data-genuitec-path="/Currency/src/main/webapp/jsp/binRegister.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-65" data-genuitec-path="/Currency/src/main/webapp/jsp/binRegister.jsp">
		<!-- Navigation -->
...
<table  cellspacing="0" cellpadding="0" border="0">
	<tr>
		<td width="25%"><img src="./resources/logo/logobw.png"></td>
		...
		<table cellspacing="0" cellpadding="5" style="margin: 0 auto;" >
			...
			<tr><td colspan="2"	><h2 style="margin: 0; padding: 0;">BIN WISE REGISTER</h2></td></tr>			
		</table>
		</td>
			...
			<tr>
				...
				<td>
					<table border="0" cellpadding="0" cellspacing="0" >
						<tr>
							<td colspan="3" style="border-bottom: #000 1px solid; padding: 10px;">Number of Bundles</td>
						</tr>
						<tr >
				...
				<td >
					<table cellpadding="0" cellspacing="0" border="0" >	
						...
						<tr>
							<td style="border-right: #000 1px solid; padding: 0 20px">Cash Officer</td>
							<td style="padding:0 20px; width: 120px; white-space: nowrap;">Chest <br>In-carger</td>						
						</tr>
					</table>
			...
			<tr>
				...
				<td>
					<table border="0" cellpadding="0" cellspacing="0" class="treecol">
						...
						<tr>
							<td style="border-right: #000 1px solid; padding: 0 44px"><span>00</span></td>
							<td style="border-right: #000 1px solid; padding: 0 58px"><span>168</span></td>
			...
			<tr>
				...
				<td>
					<table border="0" cellpadding="0" cellspacing="0" class="treecol">
						...
						<tr>
							<td style="border-right: #000 1px solid; padding: 0 40px"><span>156</span></td>
			...
			<tr>
				...
				<td>
					<table border="0" cellpadding="0" cellspacing="0" class="treecol">
						...
						<tr>
							<td style="border-right: #000 1px solid; padding: 0 50px"><span>-</span></td>
							<td style="border-right: #000 1px solid; padding:0 58px"><span>156</span></td>
							<td style="padding:0 20px"><span>NIL</span></td>
						</tr>
					</table>
				</td>
			...
			<tr>
				...
				<td>
					<table border="0" cellpadding="0" cellspacing="0" class="treecol">
						...
						<tr>
							<td style="border-right: #000 1px solid; padding: 0 44px"><span>55</span></td>
							<td style="border-right: #000 1px solid; padding:0 68px"><span>-</span></td>
			...
			<tr>
				...
				<td>
					<table border="0" cellpadding="0" cellspacing="0" class="treecol">
						...
						<tr>
							<td style="border-right: #000 1px solid; padding: 0 44px"><span>04</span></td>
							<td style="border-right: #000 1px solid; padding:0 68px"><span>-</span></td>
			...
			<tr>
				...
				<td>
					<table border="0" cellpadding="0" cellspacing="0" class="treecol">
						...
						<tr>
							<td style="border-right: #000 1px solid; padding: 0 44px"><span>76</span></td>
							<td style="border-right: #000 1px solid; padding:0 68px"><span>-</span></td>
			...
			<tr>
				...
				<td>
					<table border="0" cellpadding="0" cellspacing="0" class="treecol">
						...
						<tr>
							<td style="border-right: #000 1px solid; padding: 0 44px"><span>33</span></td>
							<td style="border-right: #000 1px solid; padding:0 68px"><span>-</span></td>
