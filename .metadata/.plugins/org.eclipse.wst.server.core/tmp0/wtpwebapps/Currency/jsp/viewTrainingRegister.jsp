...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-262" data-genuitec-path="/Currency/src/main/webapp/jsp/viewTrainingRegister.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-262" data-genuitec-path="/Currency/src/main/webapp/jsp/viewTrainingRegister.jsp">
        <!-- Navigation -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                        	<ul>
                        		<li>
                        		<a href="././trainingRegister"><i class="fa fa-table fa-fw"></i> Add Training Register</a>
                        		</li>
							</ul>Training Register List
                        </div>
   ...
   <td>${row.remarks}</td>
   <td>
<a href="editTrainingRegister?id=${row.id}">Edit</a>
</td>
   </tr>
   </c:forEach>
