...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-129" data-genuitec-path="/Currency/src/main/webapp/jsp/editRepeatabilityTestInput.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-129" data-genuitec-path="/Currency/src/main/webapp/jsp/editRepeatabilityTestInput.jsp">
		<!-- Navigation -->
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-6">
									...
									<form:form id="userPage"  name="userPage" action="updateRepeatabilityTestInput" method="post"
										...
										<div class="form-group">
											<label>Bin No</label>
											<form:input path="binNo" maxlength="45" id="binNo" name="binNo" cssClass="form-control" />
										</div>
