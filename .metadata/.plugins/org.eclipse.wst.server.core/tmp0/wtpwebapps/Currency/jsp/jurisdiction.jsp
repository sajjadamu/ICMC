...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-158" data-genuitec-path="/Currency/src/main/webapp/jsp/jurisdiction.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-158" data-genuitec-path="/Currency/src/main/webapp/jsp/jurisdiction.jsp">
		<!-- Navigation -->
	  ...
	  $("form[name='userPage']").validate({
	    ...
	    messages: {
	    	...
	    	jurisdiction: {
	    		...
	    		maxlength:"Jurisdiction can't have more than 45 characters",
	    	 },
	    	city: {
	    		loginRegexCity:"Accept only Character value",
	    		required:"Please Enter City",
	    		maxlength:"City Name can't have more than 45 characters",
	    	 },
	    	pincode: {
