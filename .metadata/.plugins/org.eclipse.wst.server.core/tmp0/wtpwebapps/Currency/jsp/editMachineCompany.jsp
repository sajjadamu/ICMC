...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-121" data-genuitec-path="/Currency/src/main/webapp/jsp/editMachineCompany.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-121" data-genuitec-path="/Currency/src/main/webapp/jsp/editMachineCompany.jsp">
		<!-- Navigation -->
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-6">
									...
									<form:form id="rbiMaster" name="rbiMaster" action="updateMachineCompany" method="post"
