...
<link rel="shortcut icon" href="./resources/logo/favicon.ico" type="image/x-icon">
    <title>ICICI : ICMC Report Data</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-231" data-genuitec-path="/Currency/src/main/webapp/jsp/viewICMCReport.jsp">

    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-231" data-genuitec-path="/Currency/src/main/webapp/jsp/viewICMCReport.jsp">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
	                    	...
	                    	<ul>
	                    		<li>
	                    			<sec:authorize access="hasRole('ADD_ICMC_REPORT')">
	                    				<a href="././addICMCReport"><i class="fa fa-table fa-fw"></i> Add ICMC Report</a>
	                    			</sec:authorize>
								</li>
							</ul>List of ICMC Report's
	                     </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <div align="center" style="color:white; background:green;"><b>${icmcReportRemovalSuccessMsg}</b></div><br>
                            
                                <!-- <table class="table table-striped table-bordered table-hover" id="dataTables-example"> -->
                                <table class="table table-striped table-bordered table-hover"    id="tableValue">
                                    <thead>
                                       <tr>
											<th>New Report Type</th>
                                    ...
                                    <tbody>
            							<c:forEach var="row" items="${records}">
											<tr>
												<td>${row.newReportType}</td>
												<td>${row.reportType}</td>
					 							<td><sec:authorize access="hasRole('UPDATE_ICMC_REPORT')">
					 									<a href="removeReport?id=${row.id}">Remove</a></sec:authorize></td>
											</tr>
										</c:forEach>
                                    </tbody>
                                </table>
