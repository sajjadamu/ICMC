...
.lg {width: 40%;}
.sm {width: 7%;	text-align: center;	font-family: arial;	font-size: 14px;}
td.first {width: 20%;}
td.a {width: 12%;}
td.c {width: 120px;}
td.a.cc {text-align: center;}
td.a.none-border-1 {border-top: 1px solid #fff;}
td.a.none-border {border-bottom: 1px solid #fff;}
tr.eqq-con td {text-align: center; font-size: 11px;}
td.a.none-border-1.no {text-align: left;}
td.a.none-border-1.no.no-1 {text-align: center;}
td.z-1 {width: 72.6%; text-align: center;}
td.z-2 {width: 20.1%; text-align: center; border-bottom: 1px solid white;}
td.qr {	width: 6.9%;}
td.center-c {width: 48.3%;	text-align: center;}
td.qrr {width: 7%;}
tr.larg {height: 76px;}
tr.eqq-con.bb td {padding: 0px;}
td.nonee {border-top: 1px solid #fff;}
td.a.cc.none-border-1.line {position: relative;	top: -27px;}
td.eqquall {width: 122px;}
.containerr tr td {	padding: 5px;}
</style>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-24" data-genuitec-path="/Currency/src/main/webapp/jsp/IO2Reports.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-24" data-genuitec-path="/Currency/src/main/webapp/jsp/IO2Reports.jsp">
		<!-- Navigation -->
				...
				<div class="col-lg-12">
					...
					<input type="button" class="btn btn-default qr-button" onclick="printDiv('printableArea')" value="Print" />
						...
						<div class="region-con">
							<form:form id="userPage" name="userPage" action="IO2Reports" method="post" modelAttribute="reportDate" autocomplete="off">
							...
							<form id="showAll">
								...
								<table>
										...
										<tr>
											<td colspan="6"><b>Name of the Bank and Chest : </b> ICICI BANK LTD. ${icmcName}, ${icmcAddress}</td>
										</tr>
										<tr>
 ...
 -->
									<table width="100%">
										...
										<tr class="eqq-con bb">
											<td class="a none-border-1 no ">Transaction in Rupee
												Coins</td>
											<td class="eqquall">Received from/sent to @ in Remittance</td>
											<td class="eqquall"></td>
											...
											<td class="eqquall"></td>
											<td class="eqquall">Total Value of Bank Notes (Same as 13) (Rs)</td>
											<td class="eqquall">Total Value of Bank Notes and coins(22+23) (Rs)</td>
											<td></td>
										...
										<tr class="eqq-con">
											<td class="a none-border-1 no">(xii) Withdrawal (Currency Transfer)</td>
											<td class="eqquall"></td>
											<td class="eqquall"></td>
										...
										<tr class="eqq-con">
											<td class="a none-border-1 no">(xiii) Closing Balance(viii+ix+x-xi-xii)</td>
											<td class="eqquall"></td>
											<td class="eqquall"></td>
									...
									<table width="100%"><tr><td>*Specify name and Code of issue Office/Chest/STO/Mint:</td></tr></table>
									</div>
									<%-- <br>
									<div>
