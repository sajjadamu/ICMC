...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-239" data-genuitec-path="/Currency/src/main/webapp/jsp/viewMachineDetails.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-239" data-genuitec-path="/Currency/src/main/webapp/jsp/viewMachineDetails.jsp">
        <!-- Navigation -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                        	<ul>
                          		<li>
                          			<a href="././addMachineDetails"><i class="fa fa-table fa-fw"></i>Add Machine Details</a>
                          		</li>
							</ul>List Of Machine 
                        </div>
                        <!-- /.panel-heading -->
                                     ...
                                     <tbody>
                                      <c:forEach var="row" items="${records}">
											<tr>
												...
												<td><fmt:formatDate pattern="dd-MMM-yy"  value="${row.purchasedate}" /></td>
												<td>${row.ageing}</td>
