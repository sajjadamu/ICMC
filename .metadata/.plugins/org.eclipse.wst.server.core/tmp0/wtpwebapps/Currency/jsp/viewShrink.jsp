...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-258" data-genuitec-path="/Currency/src/main/webapp/jsp/viewShrink.jsp">

    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-258" data-genuitec-path="/Currency/src/main/webapp/jsp/viewShrink.jsp">
        <!-- Navigation -->
                        	...
                        	<ul>
                        		<li>
                        			<sec:authorize access="hasRole('ADD_BRANCH_RECEIPT')">
                        				<a href="././Addshrink"><i class="fa fa-table fa-fw"></i> Add New</a>
                        			</sec:authorize>
                        		</li>
                        	</ul>Branch Receipt Data
                        </div>
    ...
    <c:otherwise>
        <td><sec:authorize access="hasRole('UPDATE_BRANCH_RECEIPT')">
													<a href="editShrinkPrEntry?id=${row.id}">Edit</a></sec:authorize>
												</td>
											...
											<%-- 
												...
												<td><a href="rePrintBranchQR?id=${row.id}">Re-print QR</a></td>
											</tr>
										</c:forEach>
                                    </tbody>
                                </table>
