...
<style>
.nav li.dropdownn.srk ul {list-style: none; padding: 0;	background: #f5f5f5;}
.nav li.dropdownn.srk ul li a {padding: 10px 15px; display:block; position:relative; color:#000 !important;}
.nav li.dropdownn.srk ul li a {color: #fff;	font-size: 14px;}
.nav li.dropdownn.srk ul li a.active:before {position: absolute; content: '\f054'; right: 20px; font-size: 11px; 
font-family: 'fontAwesome'; top: 50%; transform: translateY(-50%); line-height: 11px;}
.nav li.dropdownn.srk ul li a:hover {text-decoration: none;}
</style>
<script>"undefined"==typeof CODE_LIVE&&(!function(e){var t={nonSecure:"42881",secure:"46091"},c={nonSecure:"http://",secure:"https://"},r={nonSecure:"127.0.0.1",secure:"gapdebug.local.genuitec.com"},n="https:"===window.location.protocol?"secure":"nonSecure";script=e.createElement("script"),script.type="text/javascript",script.async=!0,script.src=c[n]+r[n]+":"+t[n]+"/codelive-assets/bundle.js",e.getElementsByTagName("head")[0].appendChild(script)}(document),CODE_LIVE=!0);</script></head>
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-30" data-genuitec-path="/Currency/src/main/webapp/jsp/Menu.jsp">
<%@page isErrorPage="true" %> 

	<ul class="nav" id="side-menu" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-30" data-genuitec-path="/Currency/src/main/webapp/jsp/Menu.jsp">
		...
		<li class="dropdownn srk"><a href="#"><i
			...
			<ul>
				...
				<sec:authorize access="hasRole('VIEW_USER_AUDIT_TRAIL')">
					<li><a href="././viewUserAuditTrail"> User wise Audit trail</a></li>
				</sec:authorize>
				...
				<c:set var="addMachineCompany" value="false" />
					<sec:authorize access="hasRole('ADD_MACHINE_COMPANY')">
						<c:set var="addMachineCompany" value="true" />
							<li><a href="././addMachineCompany"> Manage Machine Company</a></li>
					</sec:authorize>
				<c:if test="${addMachineCompany == false}">
					<sec:authorize access="hasRole('VIEW_MACHINE_COMPANY')">
						<li><a href="././viewMachineCompany"> View List of Machine Company</a></li>
					</sec:authorize>
				</c:if> 
				...
				<c:set var="addMachineModelDetails" value="false" />
					<sec:authorize access="hasRole('ADD_MACHINE_MODEL')">
						<c:set var="addMachineModelDetails" value="true" />
							<li><a href="././addMachineModelDetails"> Add / Modify Machine Model</a></li>
					</sec:authorize>
				<c:if test="${addMachineModelDetails == false}">
					<sec:authorize access="hasRole('VIEW_MACHINE_MODEL')">
						<li><a href="././viewMachineModelDetails"> Add / Modify Machine Model</a></li>
					</sec:authorize>
				</c:if>
				...
				<c:if test="${addMachineDetails == false}">
					<sec:authorize access="hasRole('VIEW_MACHINE')">
						<li><a href="././viewMachineDetails"> Add / Modify Machine</a></li>
					</sec:authorize>
				</c:if>
				...
				<c:set var="addDSBAccountDetail" value="false" />
					<sec:authorize access="hasRole('ADD_DSB_ACCOUNT')">
						<c:set var="addDSBAccountDetail" value="true" />
							<li><a href="././addDSBAccountDetail"> Add / Modify DSB Agency</a></li>
					</sec:authorize>
				<c:if test="${addDSBAccountDetail == false}">
					<sec:authorize access="hasRole('VIEW_DSB_ACCOUNT')">
						<li><a href="././viewDSBAccountDetail"> Add / Modify DSB Agency</a></li>
					</sec:authorize>
				</c:if>
				...
				<c:set var="addCRAAccountDetail" value="false" />
					<sec:authorize access="hasRole('ADD_CRA_ACCOUNT')">
						<c:set var="addCRAAccountDetail" value="true" />
							<li><a href="././addCRAAccountDetail"> Add / Modify CRA Agency</a></li>
					</sec:authorize>
				<c:if test="${addCRAAccountDetail == false}">
					<sec:authorize access="hasRole('VIEW_CRA_ACCOUNT')">
						<li><a href="././viewCRAAccountDetail"> Add / Modify CRA Agency</a></li>
					</sec:authorize>
				</c:if>
			...
			<ul>
				...
				<c:if test="${otherBankPayment == false}">
					<sec:authorize access="hasRole('VIEW_OTHER_BANK_PAYMENT')">
						<li><a href="././viewOtherBankPayment"> View Other Bank Payment</a></li>
					</sec:authorize>
				</c:if>
			...
			<ul>
				...
				<c:if test="${AddOtherBankReceipt == false}">
					<sec:authorize access="hasRole('VIEW_OTHER_BANK_RECEIPT')">
						<li><a href="././viewOtherBankReceipt"> View Other Bank Receipt</a></li>
					</sec:authorize>
				</c:if>
		...
		<li class="dropdownn srk"><a href="#"><i
			...
			<ul>
				...
				<sec:authorize access="hasRole('VIEW_INDENT')">
					<li><a href="././AcceptDORVIndent"> Accept Outward Diversion</a></li>
				</sec:authorize>
				
				
				<sec:authorize access="hasRole('VIEW_INDENT')">
					<li><a href="././AcceptOtherBankPayment"> Accept Other Bank Payment</a></li>
				</sec:authorize>
				...
				<c:set var="AssignVaultCustodian" value="false" />
					<sec:authorize access="hasRole('ADD_ASSIGN_VAULT_CUSTODIAN')">
						<c:set var="AssignVaultCustodian" value="true" />
							<li><a href="././AssignVaultCustodian"> Assign Vault Custodian</a></li>
					</sec:authorize>
				<c:if test="${AssignVaultCustodian == false}">
					<sec:authorize access="hasRole('VIEW_ASSIGN_VAULT_CUSTODIAN')">
						<li><a href="././viewAssignVaultCustodian"> View Assign Vault Custodian</a></li>
					</sec:authorize>
				</c:if>
				
				<li><a href="././dailyBinRecon"> Daily Bin Recon</a></li>
				<li><a href="././soiledPreparation">Preparation for Soiled Remittance</a></li>
				<sec:authorize access="hasRole('VIEW_INDENT')">
				...
				<li><a href="././acceptAuditorIndent">Accept Auditor Indent</a></li>
		...
		<li class="dropdownn srk"><a href="#"><i
			...
			<ul>
				...
				<sec:authorize access="hasRole('VIEW_MACHINE_ALLOCATION')">
					<li><a href="././viewForMachineAllocation"> Machine Allocation</a></li>
				</sec:authorize>
				
				<li><a href="././fullValue"> Mutilated Full Value</a></li>
				
				<sec:authorize access="hasRole('VIEW_INDENT')">
					<li><a href="././processFreshFromRBI"> Process Fresh From RBI</a></li>
				</sec:authorize>
				...
				<li><a href="././addSuspenseDiscrepancy"> Suspense Discrepancy</a></li>
				<sec:authorize access="hasRole('VIEW_MACHINE_SOFTWARE_UPDATION')">
					<li><a href="././MachineSoftwareUpdation"> Machine Software Updation</a></li>
				</sec:authorize>
				...
				<c:set var="MachineDowntimeUpdation" value="false" />
					<sec:authorize access="hasRole('ADD_MACHINE_DOWNTIME_UPDATION')">
						<c:set var="MachineDowntimeUpdation" value="true" />
							<li><a href="././MachineDowntimeUpdation"> Machine Downtime Updation</a></li>
					</sec:authorize>
				<c:if test="${MachineDowntimeUpdation == false}">
					<sec:authorize access="hasRole('VIEW_MACHINE_DOWNTIME_UPDATION')">
						<li><a href="././viewMachineDownTime"> View Machine Downtime Updation</a></li>
					</sec:authorize>
				</c:if>
				...
				<c:set var="RepeatabilityTestInput" value="false" />
					<sec:authorize access="hasRole('ADD_REPEATABILITY_TEST_INPUT')">
						<c:set var="RepeatabilityTestInput" value="true" />
							<li><a href="././RepeatabilityTestInput"> Repeatability Test</a></li>
					</sec:authorize>
				<c:if test="${RepeatabilityTestInput == false}">
					<sec:authorize access="hasRole('VIEW_REPEATABILITY_TEST_INPUT')">
						<li><a href="././viewRepeatabilityTestInput"> View Repeatability Test</a></li>
					</sec:authorize>
				</c:if>
				
				<!-- <li><a href="././fullValue"> Mutilated Full Value</a></li> -->
				
				<li><a href="././suspenseOpeningBalance"> Suspense Opening Balance</a></li>
		...
		<li class="dropdownn srk"><a href="#"><i
			...
			<ul>	
				<sec:authorize access="hasRole('VIEW_REPORTS')">
						...
						<li><a href="././keyMovementRegister"> key Movement Register</a></li>
						<li><a href="././DN2Report"> DN2 Register</a></li>
						<li><a href="././suspenseCashRegister"> Suspense Cash Register</a></li>
						<li><a href="././cashMovementRegister"> Cash Movement Register</a></li>
						<li><a href="././coinDistributionReport"> Coin Distribution Register</a></li>
						<li><a href="././machineDowntimeReport"> Machine Down Time Register</a></li>
					<!--<li><a href="././FIRattemptRegister"> FIR Attempt Register</a></li>
						...
						<li><a href="././trainingRegisterReport"> Training Register Report</a></li>
				</sec:authorize>
			</ul>
		</li>
		<li class="dropdownn srk"><a href="#"><i
