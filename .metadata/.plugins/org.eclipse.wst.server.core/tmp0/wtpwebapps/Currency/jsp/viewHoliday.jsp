...
<title>ICICI : Holiday Master</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-228" data-genuitec-path="/Currency/src/main/webapp/jsp/viewHoliday.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-228" data-genuitec-path="/Currency/src/main/webapp/jsp/viewHoliday.jsp">
        <!-- Navigation -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                        	<ul>
                        		<li>
                        			<sec:authorize access="hasRole('UPLOAD_HOLIDAY_MASTER')">
                        				<a href="././uploadHoliday"><i class="fa fa-table fa-fw"></i> Upload Holiday Master</a>
                        			</sec:authorize>
                        		</li>
                        	</ul>List of Holidays
                        </div>
                        ...
                        <div class="panel-body">
							<div class="row">
								<div class="col-lg-6">
									<!--<form role="form">-->
									<form:form id="userPage" name="userPage" action="getHolidayList" method="post"
										modelAttribute="user">
										...
										<div class="form-group">
											<label>Select State</label>
											 <form:select path="state" id="state" name="state" cssClass="form-control">
