...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false"
	data-genuitec-file-id="wc1-165"
	data-genuitec-path="/Currency/src/main/webapp/jsp/machineMaintenance.jsp">
							...
							<div class="row">
								<div class="col-lg-6">
									...
									<form:form id="userPage" name="userPage"
										action="saveMachineMaintenance" method="post"
										...
										<div class="form-group">
											...
											<form:input path="nextMaintainanceDate"
												id="nextMaintainanceDate" name="nextMaintainanceDate"
												cssClass="form-control" />
										</div>
