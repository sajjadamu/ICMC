...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-162" data-genuitec-path="/Currency/src/main/webapp/jsp/machineDowntimeRegister.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-162" data-genuitec-path="/Currency/src/main/webapp/jsp/machineDowntimeRegister.jsp">
		<!-- Navigation -->
...
<table width="100%"  cellpadding="0" cellspacing="0" style="font-family: arial;"  class="datewisebin">
<tr>
<td>
<table  cellspacing="0" cellpadding="0" border="0" wi>
	<tr>
		...
		<table cellspacing="0" cellpadding="5" style="margin: 0 auto;" >
			...
			<tr><td colspan="2"	><h2 style="margin: 0; padding: 0;">MACHINE DOWN TIME REGISTER</h2></td></tr>			
		</table>
		</td>
		...
		<table width="100%" border="1">
									   ...
									   <tr class="eqq-con bb">
										...
										<tr class="eqq-con bb">
											...
											<td class="eqquall">Date & Time When the issue is reported to G&D Engineer</td>
											<td class="eqquall">Date & Time When the Engineer attended the Call</td>
											<td class="eqquall">Date & Time When the Call is completed and Machine is Up</td>
											<td class="eqquall">Total time taken for uptime of the machine (D=C-A)</td>
											<td class="eqquall">Problem Description</td>
											<td class="eqquall">loss (in Bundles) due to down time - As per BSC parameter</td>
