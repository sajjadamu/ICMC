...
<style>
	.boxbor{ border:#000 3px solid; width: 875px; font-size:12px;}
        ...
        .result_boxbor_left td {padding-top: 20px; padding-bottom: 106px; font-weight: bold;}
...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-246" data-genuitec-path="/Currency/src/main/webapp/jsp/viewORVVoucher.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-246" data-genuitec-path="/Currency/src/main/webapp/jsp/viewORVVoucher.jsp">
		<!-- Navigation -->
