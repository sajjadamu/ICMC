...
.result_boxbor_mid td {
	padding: 0px;
	border-bottom: 2px solid #000;
}

.result_boxbor_mid tr:last-child td {
	padding: 0px;
	border-bottom: none;
}

.result_boxbor_mid tr td:first-child {
	padding: 0px;
	width: 107px;
	text-align: center;
}

.result_boxbor_mid tr td:nth-child(3) {
	width: 103px;
	text-align: center;
}

.result_boxbor_mid tr td:nth-child(5) {
	width: 173px;
	text-align: center;
}
...
.result_boxbor>tbody>tr>td:nth-child(1) {
	width: 10%;
}

.result_boxbor>tbody>tr>td:nth-child(2) {
	width: 40%;
}

.result_boxbor>tbody>tr>td:nth-child(3) {
	width: 55%;
}
...
.data_boxbox tr td:nth-child(1) {
	width: 97px;
}

.data_boxbox tr td:nth-child(2) {
	width: 158px;
}

.data_boxbox tr td:nth-child(3) {
	width: 97px;
}

.data_boxbox tr td:nth-child(4) {
	width: 158px;
}
...
.sigbor_box_botm td:first-child {
	width: 47%;
}
...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-246"
	data-genuitec-path="/Currency/src/main/webapp/jsp/viewORVVoucher.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false"
		data-genuitec-file-id="wc1-246"
		data-genuitec-path="/Currency/src/main/webapp/jsp/viewORVVoucher.jsp">
		<!-- Navigation -->
			...
			<div id="printableArea">
				<div class="row">
					<ul class="spaceprnt">
						...
						List<Tuple> record = (List<Tuple>) request.getAttribute("record");
						for (Tuple tuple : record) {
							for(int i=0;i<3;i++){
					%>
								...
								<tr>
									<td>
										<table class="topbox_boxbor">
											<tr>
												<td class="boxbor_lt"><img
													src="./resources/logo/logobw.png"></td>
												<td class="boxbor_heading"><b>ICICI Bank Limited.</b><br />
													<span><b>INTEGRATED CURRENCY MANAGEMENT CENTRE,
															<c:out value="${icmcName}" />
													</b></span></td>
											...
											<tr>
												...
												<td>
													<table class="bg_seprate">
														<tr>
															<td>CIT Agency:</td>
															<!-- <td>ISS SDB Security Services Pvt Ltd.</td> -->
														</tr>
													</table>
												</td>
												<td></td>
										...
										<table class="midbox_boxbor" cellpadding="0" cellspacing="0">
											<tr>
												...
												<td>Date: <fmt:formatDate type="date"
														...
														value="${now}" /></td>
												<td style="background: #e6e6e6">Name of CIT Custodian:
												</td>
												<td>Transaction Type: Payments</td>
												<td style="background: #e6e6e6"><table cellpadding="0"
														cellspacing="0" class="rt_boxbor">
														<tr>
											...
											<tr>
												...
												<td style="background: #e6e6e6"><strong>No. of
														Boxes:</strong></td>
												<td style="background: #e6e6e6"><strong>Sack
														Lock Nos:</strong></td>
											</tr>
										</table>
									...
									<td>
										<table class="result_boxbor" cellpadding="0" cellspacing="0">
											<tr>
												...
												<td>
													<table class="result_boxbor_mid" cellpadding="0"
														cellspacing="0">
														<tr>
															<td><b>Deno</b></td>
															<td></td>
						...
						.add(tuple.get(10, BigDecimal.class).multiply(BigDecimal.valueOf(1000)))
						...
						.add(BigDecimal.valueOf(10)
															...
															<td>
																<table class="result_boxres_pr">
																	<tr>
																		<td>
																			<h2>
																				<b>Handed Over By: (ICMC Official)</b>
																			</h2>
																		</td>
																	</tr>
																	<tr>
															...
															<td>
																...
																<table class="result_boxres_pr scond_result"
																	...
																	<tr>
																		<td>
																			<h2>
																				<b>Handed Over By: (CIT Custodian)</b>
																			</h2>
																		</td>
																	</tr>
																	<tr>
															...
															<td>
																<table class="result_boxres_pr scond_result"
																	...
																	<tr>
																		<td>
																			<h2>
																				<b>Received By:(Branch Official)</b>
																			</h2>
																		</td>
																	</tr>
																	<tr>
							...
							<div class="totalValueVoucher">
								<label>Total in Words: </label> <span>${numberInwords}
									only</span>
							</div>
						</li>
