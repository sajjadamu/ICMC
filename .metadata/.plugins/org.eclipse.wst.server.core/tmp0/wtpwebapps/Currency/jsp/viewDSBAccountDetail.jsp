...
<link rel="shortcut icon" href="./resources/logo/favicon.ico" type="image/x-icon">
    <title>ICICI : View DSB Account Details</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-219" data-genuitec-path="/Currency/src/main/webapp/jsp/viewDSBAccountDetail.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-219" data-genuitec-path="/Currency/src/main/webapp/jsp/viewDSBAccountDetail.jsp">
        <!-- Navigation -->
                        	...
                        	<ul>
                          		<li>
                          			<sec:authorize access="hasRole('ADD_DSB_ACCOUNT')">
                          				<a href="././addDSBAccountDetail"><i class="fa fa-table fa-fw"></i> Add DSB Account Detail</a>
                          			</sec:authorize>
                          		</li>
							</ul>View DSB Account Details
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="tableValue">
                                    ...
                                    <tbody>
                                    	<c:forEach var="row" items="${records}">
									  		<tr>
												<td>${row.dsbVendorName}</td>
												<td>${row.accountNumber}</td>
												<td><sec:authorize access="hasRole('UPDATE_DSB_ACCOUNT')">
														<a href="editDSBAccountDetail?id=${row.id}">Edit</a>
													</sec:authorize>
												</td>
											</tr>
										</c:forEach>
