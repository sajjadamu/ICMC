...
<link rel="shortcut icon" href="./resources/logo/favicon.ico" type="image/x-icon">
    <title>ICICI : List of Holidays</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-149" data-genuitec-path="/Currency/src/main/webapp/jsp/getHolidayList.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-149" data-genuitec-path="/Currency/src/main/webapp/jsp/getHolidayList.jsp">
        <!-- Navigation -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                        	<ul>
                        		<li>
                        			<a href="././viewHoliday"><i class="fa fa-table fa-fw"></i> View Holiday</a>
                        		</li>
                        	</ul>List of Holidays
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <form id="showAll">
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="tableValue">
                                    ...
                                    <tbody><%!int i=0; %>
            							<c:forEach var="row" items="${records}"><%i++; %>
											<tr>
											<th><%=i %></th>
