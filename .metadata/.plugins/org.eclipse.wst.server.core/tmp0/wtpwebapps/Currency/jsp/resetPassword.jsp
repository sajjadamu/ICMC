...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false"
	data-genuitec-file-id="wc1-185"
	data-genuitec-path="/Currency/src/main/webapp/jsp/resetPassword.jsp">
			...
			<div class="col-md-4 col-md-offset-4">
				<div class="login-panel panel panel-default">
					...
					<div class="panel-body">
						...
						<!--<form role="form">-->
						<form:form id="userPage" name="userPage" action="resetPassword"
							method="post" modelAttribute="passwordReset" autocomplete="off">
							...
							<div class="form-group">
								<form:password path="password" id="password" maxlength="45"
									name="password" cssClass="form-control"
							...
							<div class="form-group">
								<form:password path="rePassword" id="repassword"
									name="repassword" maxlength="45" class="form-control"
