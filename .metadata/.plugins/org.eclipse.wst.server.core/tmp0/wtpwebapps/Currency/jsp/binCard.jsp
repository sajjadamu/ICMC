...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false"
	data-genuitec-file-id="wc1-63"
	data-genuitec-path="/Currency/src/main/webapp/jsp/binCard.jsp">
													...
													<tr>
														...
														<td style="text-align: center;" width="90%">
															<table cellspacing="0" cellpadding="5"
																...
																<tr>
																	<td colspan="2"><h2
																			style="margin: 0; padding: 0;">BIN CARD</h2></td>
																</tr>
															</table>
														</td>
													</tr>
										...
										<tr>
											<td>
												<table cellpadding="0" cellspacing="0" border="1"
													...
													<tr>
														...
														<td>
															<table border="0" cellpadding="0" cellspacing="0">
																<tr>
																	<td colspan="3"
																		style="border-bottom: #000 1px solid; padding: 10px;">No.
																		in thousand</td>
																</tr>
																<tr>
																	<td
														...
														<td>
															<table cellpadding="0" cellspacing="0" border="0">
																...
																<tr>
																	<td
																		style="border-right: #000 1px solid; padding: 0 20px">Treasurer</td>
																	<td
													...
													<tr>
														<td class="wisespace"><span>25.07.2017</span></td>
														...
														<td>
															<table border="0" cellpadding="0" cellspacing="0"
																...
																<tr>
																	<td
																		style="border-right: #000 1px solid; padding: 0 44px"><span>Bal</span></td>
																	<td
																		style="border-right: #000 1px solid; padding: 0 58px"><span>B/F</span></td>
													...
													<tr>
														...
														<td>
															<table border="0" cellpadding="0" cellspacing="0"
																...
																<tr>
																	<td
																		style="border-right: #000 1px solid; padding: 0 52px"><span>-</span></td>
																	<td
																		style="border-right: #000 1px solid; padding: 0 61px"><span>39</span></td>
													...
													<tr>
														...
														<td>
															<table border="0" cellpadding="0" cellspacing="0"
																...
																<tr>
																	<td
																		style="border-right: #000 1px solid; padding: 0 47px"><span>10</span></td>
																	<td
																		style="border-right: #000 1px solid; padding: 0 66px"><span>-</span></td>
													...
													<tr>
														<td class="wisespace"><span>26.07.2017</span></td>
															...
															<table border="0" cellpadding="0" cellspacing="0"
																...
																<tr>
																	<td
																		style="border-right: #000 1px solid; padding: 0 52px"><span>-</span></td>
																	<td
																		style="border-right: #000 1px solid; padding: 0 61px"><span>10</span></td>
																	<td style="padding: 0 20px"><span>NIL</span></td>
																</tr>
															</table>
														</td>
													...
													<tr>
														...
														<td>
															<table border="0" cellpadding="0" cellspacing="0"
																...
																<tr>
																	<td
																		style="border-right: #000 1px solid; padding: 0 46px"><span>73</span></td>
																	<td
																		style="border-right: #000 1px solid; padding: 0 67px"><span>-</span></td>
													...
													<tr>
														...
														<td>
															<table border="0" cellpadding="0" cellspacing="0"
																...
																<tr>
																	<td
																		style="border-right: #000 1px solid; padding: 0 46px"><span>01</span></td>
																	<td
																		style="border-right: #000 1px solid; padding: 0 67px"><span>-</span></td>
													...
													<tr>
														<td class="wisespace"><span>27.07.2017</span></td>
														...
														<td>
															<table border="0" cellpadding="0" cellspacing="0"
																...
																<tr>
																	<td
																		style="border-right: #000 1px solid; padding: 0 42px"><span>130</span></td>
																	<td
																		style="border-right: #000 1px solid; padding: 0 67px"><span>-</span></td>
													...
													<tr>
														<td class="wisespace"><span>29.07.2017</span></td>
															...
															<table border="0" cellpadding="0" cellspacing="0"
																...
																<tr>
																	<td
																		style="border-right: #000 1px solid; padding: 0 52px"><span>-</span></td>
																	<td
																		style="border-right: #000 1px solid; padding: 0 57px"><span>204</span></td>
																	<td style="padding: 0 20px"><span>NIL</span></td>
																</tr>
															</table>
														</td>
													...
													<tr>
														<td class="wisespace"><span>02.08.2017</span></td>
													...
													<tr>
														<td class="wisespace"><span>03.08.2017</span></td>
														...
														<td>
															<table border="0" cellpadding="0" cellspacing="0"
																...
																<tr>
																	<td
																		style="border-right: #000 1px solid; padding: 0 51px"><span>-</span></td>
																	<td
																		style="border-right: #000 1px solid; padding: 0 62px"><span>63</span></td>
																	<td style="padding: 0 20px"><span>10</span></td>
																</tr>
															</table>
														</td>
													...
													<tr>
														...
														<td>
															<table border="0" cellpadding="0" cellspacing="0"
																...
																<tr>
																	<td
																		style="border-right: #000 1px solid; padding: 0 46px"><span>88</span></td>
																	<td
																		style="border-right: #000 1px solid; padding: 0 67px"><span>-</span></td>
													...
													<tr>
														<td class="wisespace"><span>04.08.17</span></td>
															...
															<table border="0" cellpadding="0" cellspacing="0"
																...
																<tr>
																	<td
																		style="border-right: #000 1px solid; padding: 0 51px"><span>-</span></td>
																	<td
																		style="border-right: #000 1px solid; padding: 0 62px"><span>53</span></td>
													...
													<tr>
														<td class="wisespace"><span>05.08.2017</span></td>
															...
															<table border="0" cellpadding="0" cellspacing="0"
																...
																<tr>
																	<td
																		style="border-right: #000 1px solid; padding: 0 51px"><span>-</span></td>
																	<td
																		style="border-right: #000 1px solid; padding: 0 62px"><span>45</span></td>
																	<td style="padding: 0 20px"><span>NIL</span></td>
																</tr>
															</table>
														</td>
													...
													<tr>
														<td class="wisespace"><span>08.08.2017</span></td>
														...
														<td>
															<table border="0" cellpadding="0" cellspacing="0"
																...
																<tr>
																	<td
																		style="border-right: #000 1px solid; padding: 0 42px"><span>163</span></td>
																	<td
																		style="border-right: #000 1px solid; padding: 0 67px"><span>-</span></td>
													...
													<tr>
														<td class="wisespace"><span>09.08.2017</span></td>
															...
															<table border="0" cellpadding="0" cellspacing="0"
																...
																<tr>
																	<td
																		style="border-right: #000 1px solid; padding: 0 51px"><span>-</span></td>
																	<td
																		style="border-right: #000 1px solid; padding: 0 58px"><span>105</span></td>
													...
													<tr>
														...
														<td>
															<table border="0" cellpadding="0" cellspacing="0"
																...
																<tr>
																	<td
																		style="border-right: #000 1px solid; padding: 0 41px"><span>136</span></td>
																	<td
