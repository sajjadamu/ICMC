...
<title>ICICI : Repeatability Testing</title>
...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-34" data-genuitec-path="/Currency/src/main/webapp/jsp/RepeatabilityTestInput.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-34" data-genuitec-path="/Currency/src/main/webapp/jsp/RepeatabilityTestInput.jsp">
		<!-- Navigation -->
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
                        	<ul>
                        		<li>
	                        		<a href="././viewRepeatabilityTestInput"><i
										class="fa fa-table fa-fw"></i> View Repeatability Test Details</a>
								</li>
							</ul>Repeatability Testing
                        </div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
                        	<ul>
                        		<li>
	                        		<a href="././viewRepeatabilityTestInput"><i
										class="fa fa-table fa-fw"></i> View Compatability Test Details</a>
								</li>
							</ul>Compatability Testing
                        </div>
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-6">
