...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-247"
	data-genuitec-path="/Currency/src/main/webapp/jsp/viewORVVoucher1.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false"
		data-genuitec-file-id="wc1-247"
		data-genuitec-path="/Currency/src/main/webapp/jsp/viewORVVoucher1.jsp">
		<!-- Navigation -->
		...
		<div id="page-wrapper">
			...
			<input type="button" class="btn btn-default qr-button"
				onclick="printDiv('printableArea')" value="Print All" />
					...
					%>
						...
						.add(BigDecimal.valueOf(10)
							...
							<div class="totalValueVoucher">
								<label>Total in Words: </label> <span><%= recordTotalInWord %>
									only</span>
							</div>
						</li>
