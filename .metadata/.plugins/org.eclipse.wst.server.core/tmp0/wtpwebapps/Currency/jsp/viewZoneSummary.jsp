...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false"
	data-genuitec-file-id="wc1-265"
	data-genuitec-path="/Currency/src/main/webapp/jsp/viewZoneSummary.jsp">
										...
										<form:form id="userPage" name="userPage" action="icmcSummary"
											...
											<div class="region-con-sec">
												<ul class="region-drop">
													<li><label>Select Zone</label> <span> <c:if
																test="${zone == 'NORTH'}">
																<form:select path="Zone" id="Zone" name="Zone"
																	value="NORTH" cssClass="form-control"
																	onchange="doAjaxForRegion()">
																	<form:option value="" label="Select Zone"></form:option>
																	<form:option value="NORTH">NORTH</form:option>
																</form:select>
															</c:if> <c:if test="${zone == 'SOUTH'}">
																<form:select path="Zone" id="Zone" name="Zone"
																	value="SOUTH" cssClass="form-control"
																	onchange="doAjaxForRegion()">
																	<form:option value="" label="Select Zone"></form:option>
																	<form:option value="SOUTH">SOUTH</form:option>
																</form:select>
															</c:if> <c:if test="${zone == 'EAST_AND_AP'}">
																<form:select path="Zone" id="Zone" name="Zone"
																	value="EAST_AND_AP" cssClass="form-control"
																	onchange="doAjaxForRegion()">
																	<form:option value="" label="Select Zone"></form:option>
																	<form:option value="EAST_AND_AP">EAST_AND_AP</form:option>
																</form:select>
															</c:if> <c:if test="${zone == 'WEST'}">
																<form:select path="Zone" id="Zone" name="Zone"
																	value="WEST" cssClass="form-control"
																	onchange="doAjaxForRegion()">
																	<form:option value="" label="Select Zone"></form:option>
