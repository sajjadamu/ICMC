...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-251" data-genuitec-path="/Currency/src/main/webapp/jsp/viewProcess.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-251" data-genuitec-path="/Currency/src/main/webapp/jsp/viewProcess.jsp">
		<!-- Navigation -->
											...
											<c:forEach var="row" items="${records}">
												<tr id="xyz${row.id}">
													...
													<td><input type="button" value="Cancel"
														onclick="cancelProcessedRecord('${row.id}')"></td>
