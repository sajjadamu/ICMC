...
<body oncontextmenu="return false;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-142" data-genuitec-path="/Currency/src/main/webapp/jsp/fakeNoteEntry.jsp">
	<div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-142" data-genuitec-path="/Currency/src/main/webapp/jsp/fakeNoteEntry.jsp">
		<!-- Navigation -->
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-6">
									<!--<form role="form">-->
									<form:form id="userPage" name="userPage" action="addFakeNote"
	  ...
	  $("form[name='userPage']").validate({
	    ...
	    messages: {
	    	fakeNoteDate: {
             ...
             denomination: "Please Enter denomination",
             fakeNoteSerialNumber: "Please Enter Fake Note Serial Number",
             custTellerCam: {
