						...
						<h5 style="font: bold;">From ICMC</h5>
								<%-- <form id="showAll"> --%>
									...
									<form action="suspenseCashDetailFromIcmc" method="post">
									 ...
									 <input type="text" name="id" value="${row.id}" hidden="hidden">
									<table class="table table-striped table-bordered table-hover" id="tableValue">
										...
										<tbody>
											...
											<tr>
												...
												<td><input type="number" name="withdrawal_2000" min="0"  value="${row.withdrawal_2000}" id="with2000"></td>
												<td><input type="number" name="deposit_2000" min="0" value="${row.deposit_2000}" id="dep2000"></td>
											...
											<tr>
												...
												<td><input type="number" name="withdrawal_500" id="with500" min="0" value="${row.withdrawal_500}"></td>
												<td><input type="number" name="deposit_500" id="dep500" min="0" value="${row.deposit_500}"></td>
											...
											<tr>
												...
												<td><input type="number" name="withdrawal_200" id="with200" min="0" value="${row.withdrawal_200}"></td>
												<td><input type="number" name="deposit_200" id="dep200" min="0" value="${row.deposit_200}"></td>
											...
											<tr>
												...
												<td><input type="number" name="withdrawal_100" id="with100" min="0" value="${row.withdrawal_100}"></td>
												<td><input type="number" name="deposit_100" id="dep100" min="0" value="${row.deposit_100}"></td>
												<td>${row.denomination100 + row.deposit_100 - row.withdrawal_100}</td>
											</tr>
											<tr>
												<td>50</td>
												<td id="deno50">${row.denomination50}</td>
												<td><input type="number" name="withdrawal_50" id="with50" min="0" value="${row.withdrawal_50}"></td>
												<td><input type="number" name="deposit_50" id="dep50" min="0" value="${row.deposit_50}"></td>
											...
											<tr>
												...
												<td><input type="number" name="withdrawal_20" id="with20" min="0" value="${row.withdrawal_20}"></td>
												<td><input type="number" name="deposit_20" id="dep20" min="0" value="${row.deposit_20}"></td>
											...
											<tr>
												...
												<td><input type="number" name="withdrawal_10" id="with10" min="0" value="${row.withdrawal_10}"></td>
												<td><input type="number" name="deposit_10" min="0" id="dep10" value="${row.deposit_10}"></td>
									...
									<input type="submit" value="submit" class="btn btn-default" style="width: 99px;" id="submit1">
									</form></div></div>
								<%-- </form> --%>
						</div>
												<!-- /.panel-body -->
						...
						<h5 style="font: bold;">From Link Branch</h5>
								<%-- <form id="showAll"> --%>
									...
									<c:forEach var="row" items="${openingBalance}">
									 ...
									 <input type="text" name="id" value="${row.id}" hidden="hidden">
									 Sr. Number : <input type="text" name="srNumber" value="${row.srNumber}"><br><br>
									<table class="table table-striped table-bordered table-hover" id="tableValue">
										<thead>
											<tr>
										...
										<tbody>
											...
											<tr>
												...
												<td>2000</td>
												<td>${row.denomination2000 + row.deposit_2000 - row.withdrawal_2000}</td>
												<td><input type="number" name="replenishment_2000" min="0" value="${row.replenishment_2000}"></td>
												<td><input type="number" name="depletion_2000" min="0" value="${row.depletion_2000}"></td>
											...
											<tr>
												...
												<td>500</td>
												<td>${row.denomination500 + row.deposit_500 - row.withdrawal_500}</td>
												<td><input type="number" name="replenishment_500" min="0" value="${row.replenishment_500}"></td>
												<td><input type="number" name="depletion_500" min="0" value="${row.depletion_500}"></td>
											...
											<tr>
												...
												<td>200</td>
												<td>${row.denomination200 + row.deposit_200 - row.withdrawal_200}</td>
												<td><input type="number" name="replenishment_200" min="0" value="${row.replenishment_200}"></td>
												<td><input type="number" name="depletion_200" min="0" value="${row.depletion_200}"></td>
											...
											<tr>
												...
												<td>100</td>
												<td>${row.denomination100 + row.deposit_100 - row.withdrawal_100}</td>
												<td><input type="number" name="replenishment_100" min="0" value="${row.replenishment_100}"></td>
												<td><input type="number" name="depletion_100" min="0" value="${row.depletion_100}"></td>
											...
											<tr>
												...
												<td>50</td>
												<td>${row.denomination50 + row.deposit_50 - row.withdrawal_50}</td>
												<td><input type="number" name="replenishment_50" min="0" value="${row.replenishment_50}"></td>
												<td><input type="number" name="depletion_50" min="0" value="${row.depletion_50}"></td>
											...
											<tr>
												...
												<td>20</td>
												<td>${row.denomination20 + row.deposit_20 - row.withdrawal_20}</td>
												<td><input type="number" name="replenishment_20" min="0" value="${row.replenishment_20}"></td>
												<td><input type="number" name="depletion_20" min="0" value="${row.depletion_20}"></td>
											...
											<tr>
												...
												<td>10</td>
												<td>${row.denomination10 + row.deposit_10 - row.withdrawal_10}</td>
												<td><input type="number" name="replenishment_10" min="0" value="${row.replenishment_10}"></td>
												<td><input type="number" name="depletion_10" min="0" value="${row.depletion_10}"></td>
									...
									<input type="submit" value="submit" class="btn btn-default" style="width: 99px;">
								</form>
