...
<link rel="shortcut icon" href="./resources/logo/favicon.ico"
	type="image/x-icon">
<title>ICICI : View Auditor Process</title>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-heading">
							<ul>
								<li><a href="././auditorProcessEntry"><i
										class="fa fa-table fa-fw"></i> Add Auditor Processed Data</a></li>
							</ul>
							Auditor Processed List
						</div>
										...
										<tbody>
											<c:forEach var="row" items="${records}">
												<tr id="xyz${row.id}">
													...
													<td id="bin${row.id}"><a href="rePrintAuditorQR?id=${row.id}">Re-print
															QR</a></td>
												</tr>
											</c:forEach>
										</tbody>
