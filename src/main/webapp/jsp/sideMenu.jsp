	...
	<div class="scroll-sidebar">
		...
		<nav class="sidebar-nav">
			<ul id="sidebarnav">
				...
				<li><a class="waves-effect waves-dark" href="./homeAction"
					aria-expanded="false"><i class="mdi mdi-gauge"></i><span
						class="hide-menu">Dashboard </span></a></li>
				<li><a class="has-arrow waves-effect waves-dark" href="#"
					aria-expanded="false"><i class="mdi mdi-laptop-windows"></i><span
				...
				<c:if test="${addICMCReport == false}">
					...
					<li><a href="././viewLockedUser"> Release Locked User</a></li>
								...
								<sec:authorize access="hasRole('ADD_DELEGATE_RIGHT')">
									...
									<li><a href="././addDelegateRight"> Delegate User
											Rights</a></li>
								</sec:authorize>
				...
				<c:if test="${addVendor == false}">
					...
					<li><a href="././viewJurisdiction"> Manage Jurisdiction</a></li>
								...
								<c:if test="${addMachineModelDetails == false}">
									<sec:authorize access="hasRole('VIEW_MACHINE_MODEL')">
										<li><a href="././viewMachineModelDetails"> Add /
												Modify Machine Model</a></li>
									</sec:authorize>
								</c:if>
								...
								<sec:authorize access="hasRole('ADD_MACHINE')">
									...
									<li><a href="././addMachineDetails"> Add / Modify
											Machine</a></li>
								</sec:authorize>
					...
					<li><a href="././viewServicingBranch"> Servicing Branch</a></li>
								...
								<sec:authorize access="hasRole('ADD_DSB_ACCOUNT')">
									...
									<li><a href="././addDSBAccountDetail"> Add / Modify
											DSB Agency</a></li>
								</sec:authorize>
								<c:if test="${addDSBAccountDetail == false}">
									<sec:authorize access="hasRole('VIEW_DSB_ACCOUNT')">
										<li><a href="././viewDSBAccountDetail"> Add / Modify
												DSB Agency</a></li>
									</sec:authorize>
								</c:if>
								...
								<sec:authorize access="hasRole('ADD_CRA_ACCOUNT')">
									...
									<li><a href="././addCRAAccountDetail"> Add / Modify
											CRA Agency</a></li>
								</sec:authorize>
								<c:if test="${addCRAAccountDetail == false}">
									<sec:authorize access="hasRole('VIEW_CRA_ACCOUNT')">
										<li><a href="././viewCRAAccountDetail"> Add / Modify
												CRA Agency</a></li>
									</sec:authorize>
								</c:if>
			...
			<sec:authorize access="hasAnyRole('VIEW_BIN_DASHBOARD')">
				<li><a class=" waves-effect waves-dark" href="././viewBin"
					aria-expanded="false"> <i class="mdi mdi-chart-bubble"></i> <span
						class="hide-menu">Bin Dashboard</span>
				</a></li>
			</sec:authorize>
			<li><sec:authorize access="hasRole('VIEW_SAS')">
					<a class="has-arrow waves-effect waves-dark" href="#"
						aria-expanded="false"> <i class="mdi mdi-cash"></i><span
						class="hide-menu">Cash Payment</span></a>
					<ul aria-expanded="false" class="collapse">
						<ul>
							...
							<sec:authorize access="hasRole('MUTILATED_PAYMENT')">
								<li><a href="././mutilatedPayment"> Mutilated Full
										Value</a></li>
							</sec:authorize>
							...
							<c:if test="${otherBankPayment == false}">
								<sec:authorize access="hasRole('VIEW_OTHER_BANK_PAYMENT')">
									<li><a href="././viewOtherBankPayment"> View Other
											Bank Payment</a></li>
								</sec:authorize>
							</c:if>
			...
			<li><sec:authorize access="hasRole('ADD_BRANCH_RECEIPT')">
					<a class="has-arrow waves-effect waves-dark" href="#"
						...
						class="hide-menu">Cash Receipt</span></a>
					<ul aria-expanded="false" class="collapse">
						...
						<sec:authorize access="hasRole('ADD_OTHER_BANK_RECEIPT')">
							...
							<li><a href="././AddOtherBankReceipt"> Other Bank
									Receipt</a></li>
						</sec:authorize>
			...
			<li><sec:authorize access="hasRole('VIEW_INDENT')">
					<a class="has-arrow waves-effect waves-dark" href="#"
						aria-expanded="false"> <i class="mdi mdi-diamond"></i><span
						class="hide-menu">Vault Management</span></a>
				...
				<c:if test="${binMaster == false}">
					<sec:authorize access="hasRole('VIEW_BIN')">
						...
						<sec:authorize access="hasRole('VIEW_INDENT')">
							<li><a href="././acceptMutilatedIndent"> Accept
									Mutilated Indent</a></li>
						</sec:authorize>
						<%-- <sec:authorize access="hasRole('VIEW_INDENT')">
			...
			<li><sec:authorize access="hasRole('VIEW_INDENT')">
					<a class="has-arrow waves-effect waves-dark" href="#"
						...
						class="hide-menu">Processing Room</span></a>
					...
					<ul aria-expanded="false" class="collapse">
						...
						<sec:authorize access="hasRole('VIEW_INDENT')">
							<li><a href="././processFreshFromRBI"> Process Fresh
									From RBI</a></li>
						</sec:authorize>
					...
					<li><a href="././bundleRequestForMachineProcessing"> Machinewise Allocation</a></li>
						...
						<c:if test="${discrepancy == false}">
							<sec:authorize access="hasRole('VIEW_DISCREPANCY')">
								<li><a href="././viewDiscrepancy"> View Discrepancy
										Data</a></li>
							</sec:authorize>
						</c:if>
						<sec:authorize access="hasRole('VIEW_INDENT')">
						...
						<sec:authorize access="hasRole('VIEW_INDENT')">
							<li><a href="././machineMaintenance"> Machine
									Maintenance</a></li>
						</sec:authorize>
			...
			<li><sec:authorize access="hasRole('VIEW_REPORTS')">
					<a class="has-arrow waves-effect waves-dark" href="#"
						aria-expanded="false"> <i class="mdi mdi-file-check"></i><span
					...
					<ul aria-expanded="false" class="collapse">
						<sec:authorize access="hasRole('VIEW_REPORTS')">
							...
							<li><a href="././inputOutputReports"> InputOutput
									Reports</a></li>
			...
			<li><sec:authorize access="hasRole('VIEW_INDENT')">
					<a class="has-arrow waves-effect waves-dark" href="#"
						...
						class="hide-menu">Migration</span></a>
					<ul aria-expanded="false" class="collapse">
						<sec:authorize access="hasRole('VIEW_INDENT')">
			...
			<li><sec:authorize access="hasRole('VIEW_INDENT')">
					<a class="has-arrow waves-effect waves-dark" href="#"
						...
						class="mdi mdi mdi-arrange-send-backward"></i><span
						class="hide-menu">Verification</span></a>
					<ul aria-expanded="false" class="collapse">
						<sec:authorize access="hasRole('VIEW_INDENT')">
							<li><a href="././auditorIndent"> Auditor Indent</a></li>
						</sec:authorize>
						<li><a href="././auditorMachineAllocation">Machine
								Allocation</a></li>
						<sec:authorize access="hasRole('VIEW_INDENT')">
							<li><a href="././auditorProcessEntry"> Auditor
									Processing Output</a></li>
						</sec:authorize>
