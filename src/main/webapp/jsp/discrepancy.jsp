...
'<td width="25%"><select name="discrepancyType" id="discrepancyType'+i+'" class="form-control input-margin" onchange="getMutilValue('+i+'); getFakeNotePrintYear('+i+');getSerialNumber('+i+')"><option value="SHORTAGE">SHORTAGE</option><option value="EXCESS">EXCESS</option><option value="FAKE">FAKE</option><option value="MUTILATED">MUTILATED</option></select></td>'+
'<td width="22%"><div class="desc" id="mutil'+i+'" ><select name="mutilType'+i+'" disabled="disabled" id="mutilType'+i+'" class="form-control input-margin"  onchange="doAjaxPost('+i+')"><option value="">Select</option><option value="FULL VALUE">FULL VALUE</option><option value="HALF VALUE">HALF VALUE</option><option value="ZERO VALUE">ZERO VALUE</option></td></div>'+
...
function replicateValue(i){
	...
	'<td width="22%"><input type="text" id="Denomination'+countrow+'" class="form-control input-margin" name="Denomination" onkeyup="doAjaxPost('+countrow+')" value="'+denomData+'" autofocus></td>'+
	...
	'<td width="22%"><div class="desc" id="mutil'+countrow+'" ><select name="mutilType'+countrow+'"  id="mutilType'+countrow+'" class="form-control input-margin" onchange="doAjaxPost('+countrow+')"><option value="'+mutilType+'">'+mutilType+'</option></select></td></div>'+
...
function addRow(i){
	...
	i++;
	var data= '<tr id="main'+countrow+'">'+
	'<td width="22%"><input type="text" id="Denomination'+countrow+'" class="form-control input-margin" name="Denomination" onkeyup="doAjaxPost('+countrow+')" value="" autofocus></td>'+
	'<td width="25%"><select name="discrepancyType" id="discrepancyType'+countrow+'" class="form-control input-margin" onchange="getMutilValue('+countrow+'); getFakeNotePrintYear('+countrow+')"><option value="SHORTAGE">SHORTAGE</option><option value="EXCESS">EXCESS</option><option value="FAKE">FAKE</option><option value="MUTILATED">MUTILATED</option></select></td>'+
	'<td width="22%"><div class="desc" id="mutil'+countrow+'" ><select name="mutilType'+countrow+'" disabled="disabled" id="mutilType'+countrow+'" class="form-control input-margin" onchange="doAjaxPost('+countrow+')"><option value="">Select</option><option value="FULL VALUE">FULL VALUE</option><option value="HALF VALUE">HALF VALUE</option><option value="ZERO VALUE">ZERO VALUE</option></td></div>'+
	'<td width="22%"><input type="text" id="NoteSerialNumber'+countrow+'" class="form-control input-margin" name="NoteSerialNumber" value=""></td>'+
...
function doAjaxPostInsert(str) {
	...
	for (i = 0; i <= countrow; i++) {
		var mutilType=$('#mutilType'+i).val();
		var dis = $('#discrepancyType'+i).val();
		if(dis == 'MUTILATED'){
		if(mutilType == ""){
			alert("mutilType "+mutilType);
			$('#err16').show();
			isValid = false;
		}
	...
	var accountType=$("#accountTellerCam").val();
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
                        	<ul>
                        		<li>
                        			<a href="././viewDiscrepancy"><i class="fa fa-table fa-fw"></i> View Discrepancy Data</a>
                        		</li>
							</ul>Add Discrepancy
                        </div>
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-10">
									<!--<form role="form">-->
									<form:form action="#" method="post" modelAttribute="user" autocomplete="off" enctype="multipart/form-data" id="fileUploadForm">
										
										<div class="col-lg-6 form-group">
											<label>Machine Number</label>
											<form:select path="machineNumber" id="machineNumber" cssClass="form-control">
												<option value="" label="Select Machine Number"></option>
    											<form:options items="${machineNumberList}"/>
											</form:select>
											<label id="err1" style="display: none;color: red">Please Enter Machine Number</label>
										</div>
										
										<div class="col-lg-6 form-group">
											<label>Discrepancy Date</label>
											<form:input type="text" onkeyup="return false" path="discrepancyDate" id="discrepancyDate" name="discrepancyDate" cssClass="form-control"/>
											<label id="err2" style="display: none;color: red">Please Enter Discrepancy Date</label>
										</div>
										
										<div class="col-lg-6 form-group">
											<label>SOL ID</label>
											<form:input path="solId" id="solId" name="solId" cssClass="form-control" onkeyup="doAjaxPostForBranch()" maxlength="4" />
											<label id="err3" style="display: none;color: red">Please Enter SOL ID</label>
											<label id="err13" style="display: none;color: red">Please Enter 4 Digit SOL ID</label>										
										</div>
										...
										<div class="col-lg-6 form-group">
											...
											<form:select path="accountTellerCam" id="accountTellerCam" name="accountTellerCam" cssClass="form-control" >
										...
										<div class="col-lg-6 form-group">
											...
											<label id="err6" style="display: none;color: red">Please Enter Customer name</label>
										</div>
										
										<div class="col-lg-6 form-group">
											<label>Account Number / Teller</label>
											<form:input path="accountNumber" id="accountNumber" cssClass="form-control" />
										    <label id="err7" style="display: none;color: red">Please Enter Account Number</label>
										    <label id="err17" style="display: none;color: red"> Account Number Must Be 12 Character</label>
										</div>
                                        ...
                                        <label>Number of Entries</label>
											...
											<div id="container">
											    ...
											    <label id="err9" style="display: none; color: red">Please Select Discrepancy Type, </label>
											    <label id="err10" style="display: none; color: red">Please Enter Note Serial Number, </label>
											    <label id="err11" style="display: none; color: red">Please Enter Value, </label>
											    <label id="err12" style="display: none; color: red">Please Enter Number of Notes, </label>
											    <label id="err14" style="display: none; color: red">Please Enter Remark, </label>
											    <label id="err15" style="display: none; color: red">Please Enter Valid Print Year</label>
											     <label id="err16" style="display: none; color: red">Please Enter Mutilated type</label>
											</div>
										</div> 
										<div class="col-lg-12">
