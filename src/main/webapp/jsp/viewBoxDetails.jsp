                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <!-- /.table-responsive -->
                            	<div  style="color:white; background:blue;"><b style=" margin: 20px 50px;">Free Box:-</b><b>${freeBox}</b><b style=" margin: 20px 50px;">Located Box:- </b><b>${locatedBox} </b></div><br>
