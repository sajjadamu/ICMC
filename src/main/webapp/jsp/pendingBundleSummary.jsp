...
<body oncontextmenu="return false;">
	...
	<Table align="center">
		<Tr>
			<th style="color: blue; font-size: 150%"><u>Allocated
					Pending Bundle Summary</u></th>
		</Tr>
	</Table>
	<BR>
			...
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
					...
					<%
						...
						<td><input type="radio" name="cashSource"
							value="<%=tuple.get(2, Enum.class)%>"><%=tuple.get(2, Enum.class)%></td>
						<%-- <c:out value=",Manual"/> --%>
						<%
														}
												%>
