...
<body oncontextmenu="return false;">
	<div id="wrapper">
		...
		<%-- <c:set var="currentDate" scope="session">
			<fmt:formatDate value="<%=new Date()%>" pattern="yyyy-MM-dd" />
		</c:set>

		<c:set var="binDate" scope="session" value="${binTransactionDate}">
		</c:set> --%>

		<jsp:include page="common.jsp" />

		<%-- 	<c:if
			test="${binTransactioEODDate != NULL || binTransactionDate == NULL}"><jsp:include
				page="common.jsp" /></c:if>

		<c:if
			test="${binTransactioEODDate == NULL and binTransactionDate != NULL}">
			<c:if test="${currentDate  eq binDate}"><jsp:include
					page="common.jsp" /></c:if>
			<c:if test="${currentDate  ne binDate}">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<%-- <c:if
								test="${binTransactioEODDate == NULL and binTransactionDate != NULL and (currentDate  ne binDate)}">
						EOD PENDING OF Date:<b style="color: red" id="binTransactionDate">
									<c:out value="${binTransactionDate}" />
								</b>
									...
									<form:form id="userPage" name="userPage"
										...
										<div class="region-con-sec">
											<ul class="region-drop">
												<li><span> <form:input type="text"
															path="fromDate" id="fromDate" name="fromDate"
												...
												<li><span>
														<button type="submit" class="btn btn-default"
															value="Details" style="width: 99px;">DO EOD</button>
												</span></li>
											</ul>
							...
							<div style="color: blue">
								<c:out value="${pendingMachineAloMsg}"></c:out>
							</div>
							<div style="color: blue">
								<c:out value="${processingOutPutPendingMsg}"></c:out>
							</div>
						</div>
						<!-- /.panel-body -->
					</div>
