            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <input type="button" class="btn btn-default qr-button" onclick="printPage('printableArea')" value="Print" />
              ...
              <c:forEach var="row" items="${records}">
              	...
              	<td style="display:none;" id="id${row.id}">${row.id}</td>
					...
					<td class="action"><sec:authorize access="hasRole('ACCEPT_INDENT')">
