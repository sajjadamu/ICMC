								...
								<div id="table_wrapper">
									<table cellspacing="0">
										<tbody>
											...
											<c:set var="totalPiecesCRA" value="${0}" />
											<c:set var="totalPiecesDRV" value="${0}" />
											...
											<c:forEach var="row" items="${sasList}">
												...
												<tr>
													...
													<td>${(row.totalValueOfNotesRs5S +row.totalValueOfNotesRs5F + row.totalValueOfNotesRs5I+row.totalValueOfNotesRs5U)*1000}</td>
													<td>${(row.totalValueOfNotesRs10S +row.totalValueOfNotesRs10F + row.totalValueOfNotesRs10I +row.totalValueOfNotesRs10U)*1000}</td>
													<td>${(row.totalValueOfNotesRs20S +row.totalValueOfNotesRs20F + row.totalValueOfNotesRs20I+ row.totalValueOfNotesRs20U)*1000}</td>
													<td>${(row.totalValueOfNotesRs50S + row.totalValueOfNotesRs50F + row.totalValueOfNotesRs50I+row.totalValueOfNotesRs50U)*1000}</td>
													<td>${(row.totalValueOfNotesRs100S + row.totalValueOfNotesRs100A + row.totalValueOfNotesRs100F + row.totalValueOfNotesRs100I+row.totalValueOfNotesRs100U)*1000}</td>
													<td>${(row.totalValueOfNotesRs200S + row.totalValueOfNotesRs200A + row.totalValueOfNotesRs200F + row.totalValueOfNotesRs200I+row.totalValueOfNotesRs200U)*1000}</td>
													<td>${(row.totalValueOfNotesRs500S + row.totalValueOfNotesRs500A + row.totalValueOfNotesRs500F + row.totalValueOfNotesRs500I+row.totalValueOfNotesRs500U)*1000}</td>
													<td>${(row.totalValueOfNotesRs1000S + row.totalValueOfNotesRs1000A + row.totalValueOfNotesRs1000F + row.totalValueOfNotesRs1000I)*1000}</td>
													<td>${(row.totalValueOfNotesRs2000S + row.totalValueOfNotesRs2000A + row.totalValueOfNotesRs2000F + row.totalValueOfNotesRs2000I+row.totalValueOfNotesRs2000U)*1000}</td>
													<td>${(row.totalValueOfNotesRs5S +row.totalValueOfNotesRs5F + row.totalValueOfNotesRs5I+row.totalValueOfNotesRs5U+
											   row.totalValueOfNotesRs10S + row.totalValueOfNotesRs10F + row.totalValueOfNotesRs10I +row.totalValueOfNotesRs10U+
											   row.totalValueOfNotesRs50S + row.totalValueOfNotesRs20F + row.totalValueOfNotesRs20I+ row.totalValueOfNotesRs20U+
											   row.totalValueOfNotesRs50S + row.totalValueOfNotesRs50F + row.totalValueOfNotesRs50I+row.totalValueOfNotesRs50U+
											   row.totalValueOfNotesRs100S + row.totalValueOfNotesRs100A + row.totalValueOfNotesRs100F + row.totalValueOfNotesRs100I+row.totalValueOfNotesRs100U+
											   row.totalValueOfNotesRs200S + row.totalValueOfNotesRs200A + row.totalValueOfNotesRs200F + row.totalValueOfNotesRs200I+row.totalValueOfNotesRs200U+
											   row.totalValueOfNotesRs500S + row.totalValueOfNotesRs500A + row.totalValueOfNotesRs500F + row.totalValueOfNotesRs500I+row.totalValueOfNotesRs500U+
											...
											<tr>
												...
												<td><b>${modelMap.totalValueOfBankNotes+totalValueOfBankNotesIBIT+totalValues+modelMap.denom1TotalPieces}</b></td>
												<td></td>
												<td></td>
											</tr>
										</tbody>
