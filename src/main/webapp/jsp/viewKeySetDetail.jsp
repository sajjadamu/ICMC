				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							View Key Set Details for Selected Custodian
						</div>
						<!-- /.panel-heading -->
								...
								<form id="showAll">
									...
									<table class="table table-striped table-bordered table-hover"
										...
										<tr>
											...
											<%
												List<Tuple> tupleDefinekeySet = (List<Tuple>) request.getAttribute("records");
												for (Tuple tuple : tupleDefinekeySet) {
											...
											<tr>
												...
												<td><sec:authorize
														...
														<a
															href="editDefineKeySet?id=<%=tuple.get(3, Long.class)%>">Edit</a>
													</sec:authorize></td>
											</tr>
											<%
												}
