...
$(document).ready(function() {
	...
	$('#waitingImg').hide();
	$('#processedOrUnprocessed').attr('disabled','disabled');
	var row=${row};
	dynamicRow(row);
...
+'<td><input type="text" id="Denomination'+i+'" onkeyup="doAjaxForTotal('+i+')" class="form-control input-margin" name="Denomination" onkeyup="doAjaxPost('+i+')" onkeyup="doAjaxForTotal('+i+')" value="" autofocus></td>'
	...
	if(unprocessedOrProcessed=="UNPROCESS")
	{
		...
		for (i = 0; i < val; i++) {
			...
			html += '<tr id="main'+i+'">'
					...
					+'<td><input type="text" id="Denomination'+i+'" class="form-control input-margin" name="Denomination" onkeyup="doAjaxForTotal('+i+')" onkeyup="doAjaxPost('+i+')" value="" autofocus></td>'
					+'<td><input type="text" id="Bundle'+i+'" class="form-control input-margin" name="Bundle" value="" onkeyup="doAjaxPost('+i+')" onkeyup="doAjaxForTotal('+i+')"></td>'
					+'<td><input type="text" id="TotalWithFormatter'+i+'"  onkeyup="doAjaxForTotal('+i+')" class="form-control input-margin" name="Total" value="" readonly="true"></td>'
...
var totalValue=0.00;
 ...
 $("#totalValue").val('${total}');
					...
					function replicateValue(i){
						...
						+'<td><input type="text" id="Denomination'+countrow+'" class="form-control input-margin" name="Denomination" value="'+denomData+'" onkeyup="doAjaxPost('+countrow+')" ></td>'
...
function replicateValue1(i){
						...
						$('#table1').append(data);
						countrow++;
						$('#table1').append('<tr id=addmoreButton'+rowCount+'><td><button type="button" class="addmoreButton" onclick="replicateValue1('+rowCount+');doAjaxForTotal()">Replicate Value</button></td><td><button type="button" class="addmoreButton" onclick="addRow1('+rowCount+');doAjaxForTotal()">Add Blank Row</button></td><td>Total</td><td><input class="form-control input-margin" type="text" id="totalValue"  value="" readonly ></td></tr>');
					}
					 ...
					 function addRow(i){
	                        ...
	                        +'<td><input type="text" id="Denomination'+countrow+'" class="form-control input-margin" name="Denomination" value="" onkeyup="doAjaxPost('+countrow+')"></td>'
...
for (i = 0; i <= countrow; i++) {
	 ...
	 if(($('#Denomination'+i).val()!=undefined) && $('#Denomination'+i).val()!=2000 
		...
		$.ajax({
			...
			error : function(e) {
				$('#waitingImg').hide();
				alert('Warning: ' + e.responseJSON.message); 
				$('#waitingImg').hide();
				//window.location='././viewORV';
...
function shrinkWrapBundle() {
	var processedOrUnprocessed=$('input[name=processedOrUnprocessed]:checked').val();
