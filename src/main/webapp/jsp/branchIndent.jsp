	...
	$(document)
			.ready(
								...
								.keyup(
										function() { */
											...
											for (i = 0; i < val; i++) {
												...
												html += '<tr id="main'+i+'">'
												        +'<td width="22%"><select name="Category" id="Category'+i+'" class="form-control input-margin" onClick="doAjaxPost('+i+')"><option value="ISSUABLE">ISSUABLE</option><option value="FRESH">FRESH</option><option value="ATM">ATM</option><option value="COINS">COINS</option></td>'
					...
					function addRow(i){
						...
						'<td width="22%"><select name="Category" id="Category'+countrow+'" class="form-control input-margin"><option value="ISSUABLE">ISSUABLE</option><option value="ATM">ATM</option><option value="FRESH">FRESH</option><option value="COINS">COINS</option></select></td>'+
						'<td width="22%"><select name="Denomination" id="Denomination'+countrow+'" class="form-control input-margin"><option value="2000">2000</option><option value="500">500</option><option value="200">200</option><option value="100">100</option><option value="50">50</option><option value="20">20</option><option value="10">10</option><option value="5">5</option><option value="2">2</option><option value="1">1</option></td>'+
...
for (i = 0; i <= countrow; i++) {
	 ...
	 if(($('#Denomination'+i).val()!=undefined) && $('#Denomination'+i).val()!=2000 
		...
		$.ajax({
			...
			dataType : 'json',
			url : "././sasIndentFromBranch",
			data : JSON.stringify(orvBranchWrapper),
			success : function(response) {
				alert('Record submit.');
				window.location='././branchIndent';
			},
			error : function(e) {
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<!-- <ul>
								<li><a href="././viewBranchIndent"><i class="fa fa-table fa-fw"></i>View
										Branch Indent</a></li>
							</ul> -->
							Branch Indent 
						</div>
