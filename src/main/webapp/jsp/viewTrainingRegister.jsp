...
<a href="editTrainingRegister?id=${row.id}">Edit</a>
  ...
  <td>
  <a href="deleteTrainingRegister?id=${row.id}" id="deleteFunction">Delete</a>
  </td>
   </tr>
   </c:forEach>
    ...
    $(document).ready(function()
    		{
    	      $('#deleteFunction').click(function()
    	    		  {
    	    	        var confirmAlert = confirm("If you want to Delete please click on OK else click on Cancel")
