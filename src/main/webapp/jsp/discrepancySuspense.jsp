...
<script type="text/javascript">
											...
											if (val > 0) {
												...
												for (i = 0; i < val; i++) {
													html += '<tr id="main'+i+'">'
															...
															+ ');getSerialNumber('
															+ i
															+ ')"><option value="-1">Select</option><option value="SHORTAGE">SHORTAGE</option><option value="EXCESS">EXCESS</option><option value="FAKE">FAKE</option><option value="MUTILATED">MUTILATED</option></select></td>'
															...
															+ i
															+ '"  class="form-control input-margin" name="dateOnShrinkWrap" value="" onfocus="doAjaxForDate('
															+ i
															+ ')" ></td>'
	...
	function replicateValue(i) {
		...
		var data = '<tr id="main'+countrow+'">'
				...
				+ discrepancyType
				+ '</option></select></td>'
				+ '<td width="22%"><div class="desc" id="mutil'+countrow+'" ><select name="mutilType'+countrow+'"  id="mutilType'+countrow+'" class="form-control input-margin"><option value="'+mutilType+'">'
				+ mutilType
									...
									<form:form id="#" action="#" method="post"
										...
										<div class="col-lg-12">
											...
											<input type="button" id="save" value="Submit"
												...
												onclick="doAjaxPostInsert('+i+');this.disabled=true;">
										</div>
									</form:form>
								</div>
