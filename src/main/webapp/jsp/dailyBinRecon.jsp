			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="panel panel-default">
						...
						<ul>
							...
							<form:form id="user" name="user" action="saveDataInBinTransactionBOD" method="post">
								<button type="submit" id="eod" class="btn btn-lg btn-success btn-block"
										value="Details"  disabled="disabled">EOD</button>
					...
					<input type="button" class="btn btn-default qr-button" onclick="printDiv('printableArea')" value="Print" />
						...
						<div hidden>total Bin= <b id="totalBin">${totalBin}</b></div>
						<!-- <div>initialized Bin= <b id="initializeBin">0</b></div> -->
						<div hidden>checked Bin= <b id="checkedBin">0</b></div>
						<div hidden>flag Bin= <b id="flag">0</b></div>
						</div>
