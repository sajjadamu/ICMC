											...
											'<th colspan="6" style="text-align:right">Total:'
													...
													+ api.column(5).data()
															...
															.toLocaleString(
																	'en-IN')
													+ '</th>');
									sumTotalRow = api.column(5).data().sum()
											.toLocaleString('en-IN');
								}
							});

					var processingTotal = $("#tableValue #processingTotal")
							.text();
					var processingTotalNumber = Number(processingTotal.replace(
							/[^0-9\.-]+/g, ""));
					var sumTotalRowNumber = Number(sumTotalRow.replace(
							/[^0-9\.-]+/g, ""));
