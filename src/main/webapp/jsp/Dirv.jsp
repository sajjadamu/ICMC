 ...
 */        '<td><input type="text"  id="Denomination'+i+'" maxlength="4" minlength="1" class="form-control input-margin" name="Denomination" value="" onkeyup="doAjaxPost('+i+')" autofocus></td>'+
        ...
        $('#table1').empty();
             ...
             if(unprocessedOrProcessed=="PROCESSED")
                ...
                if(val>0)
                {
                    ...
                    for (i = 0; i < val; i++) {
                    html += '<tr id="main'+i+'">'+
                       '<td width="14%"><select name="Category" id="Category'+i+'" class="form-control input-margin"><option value="ISSUABLE">ISSUABLE</option><option value="FRESH">FRESH</option><option value="ATM">ATM</option></select></td>'+
...
function replicateValue1(i){
    ...
    '<td width="15%"><select name="currencyType" id="currencyType'+countrow+'" class="form-control input-margin"><option value="ISSUABLE">ISSUABLE</option><option value="ATM">ATM</option><option value="FRESH">FRESH</option><option value="UNPROCESS">UNPROCESS</option></td>'+ 
     '<td><input type="text" id="Denomination'+countrow+'" maxlength="4" minlength="1" class="form-control input-margin" name="Denomination" value="'+denomData+'" onkeyup="doAjaxPost('+countrow+')" autofocus></td>'+
    '<td><input type="text" maxlength="45" id="Bundle'+countrow+'" class="form-control input-margin" name="Bundle" value="'+bundleData+'" onkeyup="doAjaxPost('+countrow+')" ></td>'+
    '<td width="15%"><input type="text" maxlength="45" id="TotalWithFormatter'+countrow+'"  class="form-control input-margin" name="Total" value="'+totalData+'" readonly="true"></td>'+
    '<td><input type="text" maxlength="45" id="binNumber'+countrow+'" class="form-control input-margin" name="Bin" value="" readonly="true" ></td>'+
    '<td><input type="radio"   name="binOrBox['+countrow+']" value="PROCESSING" checked="checked"></td><td>Processing</td>'+
    '<td><input type="radio"  name="binOrBox['+countrow+']" value="BIN"></td><td>BIN</td>'+
    '<td><input type="radio"  name="binOrBox['+countrow+']" value="BOX"></td><td>BOX</td>'+
...
function addRow(i){
    ...
    var data = '<tr id="main'+countrow+'">'+
    /* '<td width="15%"><select name="currencyType" id="currencyType'+countrow+'" class="form-control input-margin"><option value="ISSUABLE">ISSUABLE</option><option value="ATM">ATM</option><option value="FRESH">FRESH</option><option value="UNPROCESS">UNPROCESS</option></td>'+ */
    '<td><input type="text" id="Denomination'+countrow+'" maxlength="4" minlength="1" class="form-control input-margin" name="Denomination" value="" onkeyup="doAjaxPost('+countrow+')" autofocus></td>'+
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading"><ul><li><a href="././viewDirv"><i class="fa fa-table fa-fw"></i>View Diversion</a></li>
                            </ul>Diversion</div>
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="col-lg-6 form-group">
                                        ...
                                        <form:input type="text" path="orderDate" id="orderDate" name="orderDate"
                                            ...
                                            <label id="err1" style="display: none;color: red">Select Order Date</label>
                                    </div>
                                    ...
                                    <div class="col-lg-6 form-group">
                                        ...
                                        <form:input path="rbiOrderNo" id="rbiOrderNo" maxlength="45"
                                            cssClass="form-control" />
                                            <label id="err2" style="display: none;color: red" >Enter RBI Order Number</label>
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label>Expiry Date</label>
                                        <form:input type="text"  path="expiryDate" id="expiryDate" name="expiryDate"
                                            cssClass="form-control" />
                                            <label id="err3" style="display: none;color: red">Select Expiry Date</label>
                                    ...
                                    <div class="col-lg-6 form-group">
                                        ...
                                        <form:input path="bankName" id="bankName" name="bankName" maxlength="45"
                                            cssClass="form-control" />
                                            <label id="err4" style="display: none;color: red">Enter Bank Name Only Character</label>
                                    </div>
                                    ...
                                    <div class="col-lg-6 form-group">
                                        ...
                                        <form:input path="approvedCC" id="approvedCC" name="approvedCC" maxlength="45"
                                            cssClass="form-control" />
                                            <label id="err5" style="display: none;color: red">Enter Approved CC Only Character</label>
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        <label>Location</label>
                                        <form:input path="location" id="location" name="location" maxlength="45"
                                            cssClass="form-control" />
                                            <label id="err6" style="display: none;color: red">Enter Location Only Character</label>
                                    </div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="member" name="member" value="" maxlength="45" class="form-control"><br />
                                            <div id="container">
                                                <table id="table1">
                                                    <!-- <tr>
                                        ...
                                        <label id="err7" style="display: none;color: red">Enter Valid Denomination</label>
                                        <label id="err8" style="display: none;color: red">Enter Valid Bundle</label>
                                        <label id="err9" style="display: none;color: red">Enter Category</label>
                                        <label id="err11" style="display: none;color: red">Enter Bin</label>
                                    </form:form>
                                </div>
