...
<script type="text/javascript">
						...
						$("#member")
								.change(
										function() {
											...
											var val = $("#member").val();
											var unprocessedOrProcessed = $(
													'input[name=processedOrUnprocessed]:checked')
													.val();
												...
												if (val > 0) {
													...
													for (i = 0; i < val; i++) {
														html += '<tr id="main'+i+'">'
																...
																+ '<td><input type="text" id="Denomination'
																+ i
																+ '" maxlength="4" minlength="1" class="form-control input-margin" name="Denomination" onkeyup="doAjaxPost('
																+ i
																+ ')" value="" autofocus></td>'
													...
													$('#table1')
															.append(
																	'<tr id=addmoreButton'
																			+ (i - 1)
																			+ '><td><button type="button"  class="addmoreButton" onclick="replicateValue1('
																			+ (i - 1)
																			+ ');doAjaxForTotal()">Replicate Value</button></td><td><button type="button"  class="addmoreButton" onclick="addRow1('
																			+ (i - 1)
																			+ ');doAjaxForTotal()">Add Blank Row</button></td><td>Total</td><td><input class="form-control input-margin" type="text" id="totalValue"  value="" readonly></td></tr>');
	...
	function replicateValue1(i) {
		...
		i++;
		var data = '<tr id="main'+countrow+'">'
				+ '<td width="15%"><select name="Category" id="Category'+countrow+'" class="form-control input-margin"><option value="ISSUABLE">ISSUABLE</option><option value="ATM">ATM</option><option value="FRESH">FRESH</option><option value="UNPROCESS">UNPROCESS</option></td>'
				+ '<td><input type="text" id="Denomination'
				+ countrow
				+ '" maxlength="4" minlength="1" class="form-control input-margin" name="Denomination" value="'
				+ denomData
		...
		$('#table1')
				.append(
						'<tr id=addmoreButton'+countrow+'><td><button type="button"  class="addmoreButton" onclick="replicateValue1('
								+ countrow
								+ ');doAjaxForTotal()">Replicate Value</button></td><td><button type="button"  class="addmoreButton" onclick="addRow1('
								+ countrow
								+ ');doAjaxForTotal()">Add Blank Row</button></td><td>Total</td><td><input class="form-control input-margin" type="text" id="totalValue"  value="" readonly></td></tr>');
	...
	function SavePrint(str) {
		...
		var dirv = {
			...
			"processedOrUnprocessed" : $(
					'input[name=processedOrUnprocessed]:checked').val(),
