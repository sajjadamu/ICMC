...
<title>ICICI :Servicing Branch Upload</title>
...
<script type="text/javascript">
	function pageSubmit() {
		alert('Servicing Branch File Uploaded Successfully');
		window.location = '././viewServicingBranch';
	}
</script>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Servicing Branch</div>
						<div class="panel-body">
							<div class="row">
								<!--<form role="form">-->
								<form:form id="cash" action="UploadServicingBranch"
