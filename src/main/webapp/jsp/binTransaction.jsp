							...
							<div class="row">
								...
								<form:form id="bintransaction" name="bintransaction"
									...
									<div class="col-lg-6 form-group">
										...
										<c:if
											test="${migratedDataNotes eq 0 and migratedDataNotes eq 0 }">
											<input type="file" id="file" name="file" Class="form-control" />
										</c:if>
										<c:if
											test="${migratedDataNotes ne 0 or migratedDataNotes ne 0}">
											<input type="file" id="file" name="file" Class="form-control"
												readonly="readonly" disabled="disabled" />
											<b style="color: red">Bin Transaction has been already
												uploaded</b>
										</c:if>
										<a href="${documentFilePath}/BinTransaction.csv" download>Download
											CSV Format</a>
									...
									<div class="col-lg-12">
										<c:if
											test="${migratedDataNotes eq 0 and migratedDataNotes eq 0 }">
											<button id="uploadBinTransaction" style="width: 99px;"
												value="Details" class="btn btn-default" type="submit">Upload</button>
										</c:if>
									</div>
								</form:form>
								<!-- /.col-lg-6 (nested) -->
								...
								<form:form id="branchReceipt" name="branchReceipt"
									...
									<div class="col-lg-6 form-group">
										...
										<c:if test="${branchData ne 0 }">
											<input type="file" id="file" name="file" Class="form-control"
												readonly="readonly" disabled="disabled" />
											<b style="color: red">Branch Receipt has been already
												uploaded</b>
										</c:if>
										<a href="${documentFilePath}/branchReceipt.csv" download>Download
											CSV Format</a>
									</div>

									<div class="col-lg-12">
										<c:if test="${branchData eq 0 }">
											<button id="uploadBranchReceipt" style="width: 99px;"
												value="Details" class="btn btn-default" type="submit">Upload</button>
										</c:if>
									</div>
								</form:form>
