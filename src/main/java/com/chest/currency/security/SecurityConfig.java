...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	 ...
	 * 
	 * auth.ldapAuthentication().contextSource().url(ldapURL + "/dc=" +
	 * ldapDomain).and().userSearchBase("ou=people")
	 * .userSearchFilter("(uid={0})").ldapAuthoritiesPopulator(
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/app/login").permitAll().antMatchers("/app/resetPasswordRequest")
				...
				.hasRole(PermissionName.UPDATE_ROLE.val).antMatchers("/app/viewRole/**")
				.hasRole(PermissionName.VIEW_ROLE.val)

				.antMatchers("/app/addICMC/**").hasRole(PermissionName.ADD_ICMC.val).antMatchers("/app/saveICMC/**")
				.hasAnyRole(PermissionName.ADD_ICMC.val, PermissionName.UPDATE_ICMC.val)
				...
				.antMatchers("/app/saveICMCReport/**")
				.hasAnyRole(PermissionName.ADD_ICMC_REPORT.val, PermissionName.UPDATE_ICMC_REPORT.val)
				...
				.antMatchers("/app/saveBranch/**")
				.hasAnyRole(PermissionName.ADD_BRANCH.val, PermissionName.UPDATE_BRANCH.val)
				...
				.antMatchers("/app/addUser/**").hasRole(PermissionName.ADD_USER.val).antMatchers("/app/saveUser/**")
				.hasAnyRole(PermissionName.ADD_USER.val, PermissionName.UPDATE_USER.val).antMatchers("/app/editUser/**")
				.hasRole(PermissionName.UPDATE_USER.val).antMatchers("/app/updateUser/**")
				.hasRole(PermissionName.UPDATE_USER.val).antMatchers("/app/viewAll/**")
				.hasRole(PermissionName.VIEW_USER.val)
				...
				.antMatchers("/app/saveDelegateRight/**")
				.hasAnyRole(PermissionName.ADD_DELEGATE_RIGHT.val, PermissionName.UPDATE_DELEGATE_RIGHT.val)
				...
				.antMatchers("/app/saveJurisdiction/**")
				.hasAnyRole(PermissionName.ADD_JURISDICTION.val, PermissionName.UPDATE_JURISDICTION.val)
				...
				.antMatchers("/app/saveMachineModelDetails/**")
				.hasAnyRole(PermissionName.ADD_MACHINE_MODEL.val, PermissionName.UPDATE_MACHINE_MODEL.val)
				...
				.antMatchers("/app/saveMachineDetails/**")
				.hasAnyRole(PermissionName.ADD_MACHINE.val, PermissionName.UPDATE_MACHINE.val)
				...
				.antMatchers("/app/saveRbiMaster/**")
				.hasAnyRole(PermissionName.ADD_RBI_MASTER.val, PermissionName.UPDATE_RBI_MASTER.val)
				...
				.antMatchers("/app/saveMachineCompany/**")
				.hasAnyRole(PermissionName.ADD_MACHINE_COMPANY.val, PermissionName.UPDATE_MACHINE_COMPANY.val)
				...
				.antMatchers("/app/saveDSBAccountDetail/**")
				.hasAnyRole(PermissionName.ADD_DSB_ACCOUNT.val, PermissionName.UPDATE_DSB_ACCOUNT.val)
				...
				.antMatchers("/app/saveCRAAccountDetail/**")
				.hasAnyRole(PermissionName.ADD_CRA_ACCOUNT.val, PermissionName.UPDATE_CRA_ACCOUNT.val)
				...
				.antMatchers("/app/saveBinCapacity/**")
				.hasAnyRole(PermissionName.ADD_BIN_CAPACITY.val, PermissionName.UPDATE_BIN_CAPACITY.val)
				...
				.antMatchers("/app/saveDataInBin/**")
				.hasAnyRole(PermissionName.ADD_BIN.val, PermissionName.UPDATE_BIN.val)
				...
				.antMatchers("/app/updateIndentStatus/**")
				.hasAnyRole(PermissionName.ACCEPT_INDENT.val, PermissionName.UPDATE_INDENT.val)
				...
				.antMatchers("/app/AddDefineKeySet/**")
				.hasAnyRole(PermissionName.ADD_DEFINE_KEYSET.val, PermissionName.UPDATE_DEFINE_KEYSET.val)
				...
				.antMatchers("/app/AddAssignVaultCustodian/**")
				.hasAnyRole(PermissionName.ADD_ASSIGN_VAULT_CUSTODIAN.val,
						PermissionName.UPDATE_ASSIGN_VAULT_CUSTODIAN.val)
				.antMatchers("/app/editAssignVaultCustodian/**")
				.hasRole(PermissionName.UPDATE_ASSIGN_VAULT_CUSTODIAN.val)
				.antMatchers("/app/updateAssignVaultCustodian/**")
				.hasRole(PermissionName.UPDATE_ASSIGN_VAULT_CUSTODIAN.val)
				...
				.antMatchers("/app/addCITCRAVendor/**")
				.hasAnyRole(PermissionName.ADD_CIT_CRA_VENDOR.val, PermissionName.UPDATE_CIT_CRA_VENDOR.val)
				...
				.antMatchers("/app/addCITCRAVehicle/**")
				.hasAnyRole(PermissionName.ADD_CIT_CRA_VEHICLE.val, PermissionName.UPDATE_CIT_CRA_VEHICLE.val)
				...
				.antMatchers("/app/addCITCRADriver/**")
				.hasAnyRole(PermissionName.ADD_CIT_CRA_DRIVER.val, PermissionName.UPDATE_CIT_CRA_DRIVER.val)
				...
				.antMatchers("/app/DSB/**").hasRole(PermissionName.ADD_DSB.val).antMatchers("/app/viewDSB/**")
				.hasRole(PermissionName.VIEW_DSB.val)
				...
				.antMatchers("/app/saveIndentRequest/**")
				.hasAnyRole(PermissionName.ADD_INDENT.val, PermissionName.UPDATE_INDENT.val)
				...
				.antMatchers("/app/bundleRequestForMachineProcessing/**")
				.hasRole(PermissionName.VIEW_BUNDLE_REQUEST_FOR_MACHINE.val)

				.antMatchers("/app/MachineDowntimeUpdation/**")
				.hasRole(PermissionName.ADD_MACHINE_DOWNTIME_UPDATION.val)
				.antMatchers("/app/AddMachineDowntimeUpdation/**")
				.hasAnyRole(PermissionName.ADD_MACHINE_DOWNTIME_UPDATION.val,
				...
				.antMatchers("/app/updateMachineDownTime/**")
				.hasRole(PermissionName.UPDATE_MACHINE_DOWNTIME_UPDATION.val).antMatchers("/app/viewMachineDownTime/**")
				.hasRole(PermissionName.VIEW_MACHINE_DOWNTIME_UPDATION.val)

				.antMatchers("/app/MachineSoftwareUpdation/**")
				.hasRole(PermissionName.ADD_MACHINE_SOFTWARE_UPDATION.val).antMatchers("/app/AddMachineSoftware/**")
				.hasAnyRole(PermissionName.ADD_MACHINE_SOFTWARE_UPDATION.val,
				...
				.antMatchers("/app/updateMachineSoftware/**")
				.hasRole(PermissionName.UPDATE_MACHINE_SOFTWARE_UPDATION.val).antMatchers("/app/viewMachineSoftware/**")
				.hasRole(PermissionName.VIEW_MACHINE_SOFTWARE_UPDATION.val)

				.antMatchers("/app/RepeatabilityTestInput/**").hasRole(PermissionName.ADD_REPEATABILITY_TEST_INPUT.val)
				.antMatchers("/app/AddRepeatabilityTestInput/**")
				.hasAnyRole(PermissionName.ADD_REPEATABILITY_TEST_INPUT.val,
						PermissionName.UPDATE_REPEATABILITY_TEST_INPUT.val)
				.antMatchers("/app/editRepeatabilityTestInput/**")
				.hasRole(PermissionName.UPDATE_REPEATABILITY_TEST_INPUT.val)
				.antMatchers("/app/updateRepeatabilityTestInput/**")
				.hasRole(PermissionName.UPDATE_REPEATABILITY_TEST_INPUT.val)
				.antMatchers("/app/viewRepeatabilityTestInput/**")
				.hasRole(PermissionName.VIEW_REPEATABILITY_TEST_INPUT.val)

				.antMatchers("/app/RepeatabilityTestOutput/**")
				.hasRole(PermissionName.ADD_REPEATABILITY_TEST_OUTPUT.val)
				.antMatchers("/app/AddRepeatabilityTestOutput/**")
				.hasAnyRole(PermissionName.ADD_REPEATABILITY_TEST_OUTPUT.val,
						PermissionName.UPDATE_REPEATABILITY_TEST_OUTPUT.val)
				.antMatchers("/app/editRepeatabilityTestOutput/**")
				.hasRole(PermissionName.UPDATE_REPEATABILITY_TEST_OUTPUT.val)
				.antMatchers("/app/updateRepeatabilityTestOutput/**")
				.hasRole(PermissionName.UPDATE_REPEATABILITY_TEST_OUTPUT.val)
				.antMatchers("/app/viewRepeatabilityTestOutput/**")
				.hasRole(PermissionName.VIEW_REPEATABILITY_TEST_OUTPUT.val)

				.antMatchers("/app/FreshCurrency/**").hasRole(PermissionName.ADD_FRESH_CURRENCY.val)
				.antMatchers("/app/AddFreshCurrency/**")
				.hasAnyRole(PermissionName.ADD_FRESH_CURRENCY.val, PermissionName.UPDATE_FRESH_CURRENCY.val)
				...
				.antMatchers("/app/DorvAllocation/**")
				.hasAnyRole(PermissionName.ADD_DIVERSION_PAYMENT.val, PermissionName.UPDATE_DIVERSION_PAYMENT.val)

				.antMatchers("/app/ORVBranch/**").hasRole(PermissionName.ADD_BRANCH_PAYMENT.val)
				.antMatchers("/app/orvBranchAllocation/**")
				.hasAnyRole(PermissionName.ADD_BRANCH_PAYMENT.val, PermissionName.UPDATE_BRANCH_PAYMENT.val)

				.antMatchers("/app/Soiled/**").hasRole(PermissionName.ADD_SOILED_REMITTANCE.val)
				.antMatchers("/app/soiledRemittance/**")
				.hasAnyRole(PermissionName.ADD_SOILED_REMITTANCE.val, PermissionName.UPDATE_SOILED_REMITTANCE.val)
				...
				.antMatchers("/app/CRAAllocation/**")
				.hasAnyRole(PermissionName.ADD_CRA_PAYMENT.val, PermissionName.UPDATE_CRA_PAYMENT.val)
				...
				.antMatchers("/app/OtherBankAllocation/**")
				.hasAnyRole(PermissionName.ADD_OTHER_BANK_PAYMENT.val, PermissionName.UPDATE_OTHER_BANK_PAYMENT.val)
				...
				.permitAll().and().csrf().disable().sessionManagement().maximumSessions(1);
	}
