...
public class CITCRAVendor {
	...
	@JoinTable(name = "CIT_CRA_VENDOR_ICMC_ASSO", joinColumns = @JoinColumn(name = "VENDOR_ID", referencedColumnName = "ID"), inverseJoinColumns = @JoinColumn(name = "ICMC_ID", referencedColumnName = "ID"))
